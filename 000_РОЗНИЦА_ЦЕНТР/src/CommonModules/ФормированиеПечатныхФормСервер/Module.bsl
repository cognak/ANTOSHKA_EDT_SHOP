...
Функция СформироватьЗаголовокДокумента(Шапка, НазваниеДокумента = "", Знач КодЯзыка = "uk", ДатаКратко = Ложь) Экспорт
	...
	//	+ " № " + ПрефиксацияОбъектовКлиентСервер.ПолучитьНомерНаПечать(Шапка.Номер, Ложь, Истина)
		+ " № " + СокрЛП(Шапка.Номер)
		+ " від " + ?(ДатаКратко, Формат(Шапка.Дата, "ДФ=dd.MM.yyyy"), Формат(Шапка.Дата, "ДФ='дд ММММ гггг';Л=uk_UA") + " р.");
