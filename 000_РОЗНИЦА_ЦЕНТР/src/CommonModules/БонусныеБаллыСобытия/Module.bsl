		...
		//	вдруг маркетингу взбрендит детализировать сообщение!
			...
			Пока ВыборкаАбоненты.Следующий() Цикл
				...
				Попытка
					...
					Если ПроверитьСостояниеПоследовательности(ВыборкаАбоненты.Контрагент) Тогда	//	LNK 26.06.2024 07:16:04
					
						ТекстСообщения = "";

						Если ОтправитьОповещениеАннуляции(ВыборкаАбоненты, ТекстСообщения, Отладка) Тогда
...
//	Транслит.. SMS чёта не хочет кириллицей отправляться..	
