...
// Возвращает структуру с начальными значениями данных для интеграции с Microsoft Dynamics.
//
// Возвращаемое значение:
//   Структура:
//     * Контрагент - СправочникСсылка.Контрагенты - пустая ссылка на контрагента
//     * ДисконтнаяКарта - СправочникСсылка.ИнформационныеКарты - пустая ссылка на информационную карту
//     * НомерТелефона - Строка - номер телефона
//     * IDD - Строка - идентификатор клиента
//     * Отложено - Булево - признак отложенности
//     * ПоискВыполнен - Булево - признак того, что поиск был выполнен (Истина означает, что поиск выполнен, но ссылка не найдена)
...
Функция ИнициализироватьСоставДанных()	Экспорт
	...
	СоставДанных.Вставить("Контрагент", Справочники.Контрагенты.ПустаяСсылка());
	СоставДанных.Вставить("ДисконтнаяКарта", Справочники.ИнформационныеКарты.ПустаяСсылка());	СоставДанных.Вставить("НомерТелефона", "");
	СоставДанных.Вставить("IDD", "");
	СоставДанных.Вставить("Отложено", Ложь);
	СоставДанных.Вставить("ПоискВыполнен", Ложь);
	СоставДанных.Вставить("Ошибка", Ложь);
	СоставДанных.Вставить("ОписаниеОшибки", "");
