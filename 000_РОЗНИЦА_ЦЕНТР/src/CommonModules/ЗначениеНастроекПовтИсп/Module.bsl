...
Функция ПолучитьПараметрыКассыККМ(КассаККМ) Экспорт
	...
	Возврат Справочники.КассыККМ.ПолучитьПараметрыКассыККМ(КассаККМ);
...
Функция ПолучитьКассуОрганизацииПоУмолчанию(
	...
	Если НЕ ЗначениеЗаполнено(Касса) 
		...
		Если ЗначениеЗаполнено(Пользователь) Тогда
			...
			И НЕ Справочники.Кассы.РеквизитыКассы(Касса).Организация = Организация
			Тогда
...
Функция ПолучитьОрганизациюПоУмолчанию(Знач Организация = Неопределено, Пользователь = Неопределено) Экспорт
	...
	ИначеЕсли ЗначениеЗаполнено(Организация) Тогда	//	LNK 15.11.2023 16:31:58

			Возврат Организация;

	Иначе	Возврат ПараметрыСеанса.ТекущаяОрганизация;
...
Функция ПолучитьКассуККМПоУмолчанию(Знач Организация = Неопределено, Знач КассаККМ = Неопределено, Знач Магазин = Неопределено, Пользователь = Неопределено) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(КассаККМ) Тогда
		...
		Если ЗначениеЗаполнено(Пользователь) Тогда	
			...
			Иначе	Возврат Справочники.КассыККМ.КассаПоУмолчанию(Организация, Магазин);
