...
//     * ДанныеОтвета - Структура - данные ответа, распарсенные из JSON
//     * ТекстОтвета - Строка - полный текст ответа банка
Функция ВыполнитьЗапросКСерверу(ИмяПроцедуры, ТекстЗапроса, ДанныеСоединения, Метод = "POST", Знач Таймаут = 40) Экспорт
	...
	Если НЕ ПустаяСтрока(ТекстЗапроса) Тогда
		...
		//	формирование заголовка
			...
			Результат.ТекстОтвета = ТекстОтвета;
...
Процедура ВозвратКредитнойПрограммы(ДанныеЗапроса, ДанныеСоединения, ДанныеОтвета) Экспорт
	...
	ДанныеОтвета.ТекстОтвета = Результат.ТекстОтвета;
