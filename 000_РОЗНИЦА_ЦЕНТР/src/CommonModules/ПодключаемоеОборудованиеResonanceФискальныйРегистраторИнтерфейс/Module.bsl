...
Функция ДобавитьСлип(ОбъектДрайвера,Параметры,ИндексОплаты) Экспорт
	...
	Успешно = ОбъектДрайвера.FreeTextLine(0,0,0,"Terminal ID: "+СокрЛП(ПлатежныеРеквизиты.term_id))=1;
	...
	Успешно = ОбъектДрайвера.FreeTextLine(0,0,0,"Auth code: "+СокрЛП(ПлатежныеРеквизиты.auth_code))=1;
