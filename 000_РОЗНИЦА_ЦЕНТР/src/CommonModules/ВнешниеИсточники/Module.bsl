...
Функция УстановитьМагазинПоДаннымNavision(НомерМагазина, ДанныеNavision, ОбновитьАналитику, СкладСсылка)
	...
	Если ЗначениеЗаполнено(НомерМагазина) Тогда
		...
		Если СкладУправляющейСистемы Тогда
			...
			|	И ТаблицаСправочник.СкладСвязи = &СкладСвязи"
			);
