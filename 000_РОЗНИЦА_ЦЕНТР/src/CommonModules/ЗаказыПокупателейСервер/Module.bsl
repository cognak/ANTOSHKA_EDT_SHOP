...
// Получить соответствие представлений товара.
// 
// Параметры:
//  СписокТоваров - Массив из СправочникСсылка.Номенклатура - Список товаров
// 
// Возвращаемое значение:
//  Соответствие - Получить соответствие представлений товара
...
// Возвращает соответствие наименований товаров по данным из системы Magento
//
// Параметры:
...
Процедура СоздатьЗаказыПокупателя() Экспорт
	...
	Запрос.Текст =
		...
		|	ИнтернетЗаказВнешниеДанные.ПолученныеДанные,
		|	ИнтернетЗаказВнешниеДанные.КоличествоПолучений,
		|	ИнтернетЗаказВнешниеДанные.ПоследняяОшибка,
		|	ИнтернетЗаказВнешниеДанные.УникальныйИдентификатор
		|ИЗ
