...
// 
// Параметры:
//  СписокТоваров - Массив, СправочникСсылка.Номенклатура - Список товаров
// 
// Возвращаемое значение:
...
//	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
//		СоответствиеНаименования.Вставить(ВыборкаДетальныеЗаписи.Ссылка, ВыборкаДетальныеЗаписи.ПолноеНаименованиеТовара);
//	КонецЦикла;
//	
