...
Функция ПараметрЗапросаТоварыЗапросаДоступности(ДокЗапросДоступности) 
	...
	Запрос.Текст = 
		...
		|	ЗПТовары.Сумма КАК Сумма,
		|	ЗПТовары.СуммаАвтоматическойСкидки КАК СуммаАвтоматическойСкидки,
		|	ЗПТовары.СуммаБонусныхБалловНачислено КАК СуммаБонусныхБалловНачислено,
		|	ЗПТовары.СуммаБонусныхБалловСписано КАК СуммаБонусныхБалловСписано,
		|	ЗПТовары.СуммаНДС КАК СуммаНДС,
		|	ЗПТовары.СуммаРучнойСкидки КАК СуммаРучнойСкидки,
