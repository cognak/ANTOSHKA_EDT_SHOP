					...
					//	Остановка = 1;
						...
						Если ВыборкаЗД.Следующий() Тогда
							...
							ИначеЕсли ОчередьNavisionВыборка.ID2 = "ОТГРУЖЕН" Тогда
								...
								Если ДанныеСостояния = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.Согласован
								...
								ИначеЕсли ДанныеСостояния = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.ВРаботе
									И ТипЗнч(ЗапросДоступностиОбъект.МагазинОтправитель) = Тип("СправочникСсылка.Склады") Тогда
