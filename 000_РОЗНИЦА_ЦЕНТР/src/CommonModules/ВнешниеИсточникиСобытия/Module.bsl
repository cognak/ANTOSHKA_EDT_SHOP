...
//	LNK 25.10.2019 11:06:57 - специфика Документы.ЗаказПокупателя
	...
	//	LNK 21.11.2023 20:06:35
		Параметры.Вставить("КодОтдела", ОбщегоНазначенияРТповтИсп.РеквизитыМагазина(ОбъектДанных.МагазинОтправитель, ОбъектДанных.Дата).IDN_Организация);
...
Функция ОчередьУстановитьЗадание(Период, ТипЗадания, ID1, ID2 = "", ID3 = "", ID4 = "", ID5 = "", ID6 = "", ID7 = "", ID8 = "", ID9 = "")
	...
	НомерЗадания = 0;
	ТекстЗапроса = "SET NOCOUNT ON" + Символы.ПС + ОчередьУстановкиЗаданияТекстЗапроса(Период, ТипЗадания, ID1, ID2, ID3, ID4, ID5, ID6, ID7, ID8, ID9, Истина);
...
Функция ОчередьУстановкиЗаданияТекстЗапроса(Период, ТипЗадания, ID1, ID2 = "", ID3 = "", ID4 = "", ID5 = "", ID6 = "", ID7 = "", ID8 = "", ID9 = "", ВернутьID = Истина)
