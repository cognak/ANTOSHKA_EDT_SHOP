...
//	LNK 07.04.2017 16:15:21
Процедура ПриОпределенииПрефиксаМагазина(Магазин, ПрефиксМагазина)	Экспорт
	...
	Запрос = Новый Запрос(
	"ВЫБРАТЬ
	|	ТаблицаСправочник.НомерМагазина
	|ИЗ
	...
	Если Выборка.Следующий() Тогда
			...
			ПрефиксМагазина = Формат(Выборка.НомерМагазина, "ЧГ=");

	Иначе	ПрефиксМагазина = "";
