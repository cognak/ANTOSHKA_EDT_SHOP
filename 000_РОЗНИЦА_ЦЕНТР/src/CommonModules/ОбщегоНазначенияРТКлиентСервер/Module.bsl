...
Процедура ОбновитьСостояниеЭлемента(Объект, СостояниеДокумента, КартинкаСостоянияДокумента)	Экспорт
	...
	ИначеЕсли Объект.ПометкаУдаления ИЛИ Объект.Блокирован Тогда

		СостояниеДокумента = "Блокирован";
		КартинкаСостоянияДокумента = 1;
