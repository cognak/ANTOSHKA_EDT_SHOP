...
//	Кешировать результат нельзя, так как изменение политики должно сразу же вступать в силу.
	...
	|	ЕСТЬNULL(ТаблицаОрганизаций.Организация, ЗНАЧЕНИЕ(Справочник.Организации.ПустаяСсылка)) КАК ОрганизацияИнтернетМагазина,
	...
	|	ТаблицаВедущая.ИспользоватьЧекиКакРегистраторыНачисленияБонусныхБаллов КАК ИспользоватьЧекиКакРегистраторыНачисленияБонусныхБаллов,
	...
	|	ТаблицаВедущая.РазрешитьОплатуБонуснымиБалламиПодарочныхСертификатов КАК РазрешитьОплатуБонуснымиБалламиПодарочныхСертификатов,
