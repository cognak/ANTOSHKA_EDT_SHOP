...
//	Кешировать результат нельзя, так как изменение политики должно сразу же вступать в силу.
	...
	|	ТаблицаРегистра.ИспользоватьЧекиКакРегистраторыНачисленияБонусныхБаллов КАК
	...
	|	ТаблицаРегистра.РазрешитьОплатуБонуснымиБалламиПодарочныхСертификатов КАК
	...
	|	ТаблицаРегистра.СуммаДоставкиЗаказаПокупателя,
	|	ТаблицаРегистра.СуммаБесплатнойДоставки
	|ИЗ
