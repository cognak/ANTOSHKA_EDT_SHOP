			...
			Для каждого СтрокаТаблицы Из ТаблицаСсылок Цикл
				...
				Попытка
					...
					ИначеЕсли СтрокаТаблицы.Метаданные = Метаданные.РегистрыСведений.КлючевыеАтрибутыЗаказовПокупателей Тогда
						...
						НаборЗаписей.Отбор.ЗаказПокупателя.Установить(ОбъектыВыборка.Объект);
						НаборЗаписей.Записать();
					...
					ИначеЕсли СтрокаТаблицы.Метаданные = Метаданные.РегистрыСведений.ОплатаЗаказаКлиента Тогда
						...
						НаборЗаписей.Отбор.ЗаказКлиента.Установить(ОбъектыВыборка.Объект);
						НаборЗаписей.Записать();
					...
					ИначеЕсли СтрокаТаблицы.Метаданные = Метаданные.РегистрыСведений.СтатусыЗаказовПокупателей Тогда
						...
						НаборЗаписей.Отбор.Заказ.Установить(ОбъектыВыборка.Объект);
						НаборЗаписей.Записать();

						СтрокиУдалить.Добавить(СтрокаТаблицы);

					ИначеЕсли СтрокаТаблицы.Метаданные = Метаданные.Документы.ЧекККМ
							И СтрокаТаблицы.Данные.ПолучитьОбъект() = Неопределено Тогда
