...
//	LNK 29.05.2019 15:05:13
Процедура УстановитьЗащитуОтОпасныхДействий(ПредупреждатьОбОпасныхДействиях)	Экспорт
	...
	Для каждого ПользовательИБ Из ПользователиИнформационнойБазы.ПолучитьПользователей() Цикл
		...
		УстановитьАтрибут = Ложь;

		Если ОписаниеЗащитыОтОпасныхДействий.ПредупреждатьОбОпасныхДействиях Тогда

			Если НЕ ПользовательИБ.Роли.Содержит(Метаданные.Роли.АдминистраторСистемы)
				И НЕ ПользовательИБ.ЗащитаОтОпасныхДействий.ПредупреждатьОбОпасныхДействиях = ПредупреждатьОбОпасныхДействиях Тогда

				УстановитьАтрибут = Истина;

			КонецЕсли;

		ИначеЕсли НЕ ПользовательИБ.ЗащитаОтОпасныхДействий.ПредупреждатьОбОпасныхДействиях = ПредупреждатьОбОпасныхДействиях Тогда

			УстановитьАтрибут = Истина;

		КонецЕсли;

		Если УстановитьАтрибут Тогда

			ПользовательИБ.ЗащитаОтОпасныхДействий = ОписаниеЗащитыОтОпасныхДействий;
