...
Процедура РегистрацияВыполненияHttpСервиса(ИмяWS, ИмяПроцедуры, Параметр1 = "", Параметр2 = "", Параметр3 = "", Параметр4 = "", Параметр5 = "")	Экспорт
	...
	ЗаписьЖурналаРегистрации("HttpСервисы", УровеньЖурналаРегистрации.Информация
	, Метаданные.HTTPСервисы[ИмяWS]//.Операции[ИмяПроцедуры]
	,, "PROC: " + ИмяПроцедуры + Символы.ПС + Комментарий, РежимТранзакцииЗаписиЖурналаРегистрации.Независимая);
