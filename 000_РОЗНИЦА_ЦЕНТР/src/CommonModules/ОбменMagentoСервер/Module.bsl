...
//			Если ГородДоставки = Неопределено Тогда
//				
//				ГородДоставки = Справочники.ГородаДоставки.НайтиГород(ЗначениеПоТипу(ДанныеВнешние.Delivery, "City", Тип("Строка")), ДокументОбъект.ОператорДоставки);
//				
//			КонецЕсли;
