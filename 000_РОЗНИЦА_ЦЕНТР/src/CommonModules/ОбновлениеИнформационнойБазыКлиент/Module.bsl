...
Процедура ОбновитьИнформационнуюБазу(Отказ = Ложь, ПриЗапускеКлиентскогоПриложения = Ложь) Экспорт
	...
	ТекстСостояния = "Зачекайте, будь ласка, виконується оновлення інформаційної бази...";
	...
	Если ИнформацияОбОшибке <> Неопределено Тогда
		...
		ТекстСообщенияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			"При оновленні версії програми виникла помилка
			|
			|%1",
	...
	Состояние("Оновлення інформаційної бази виконано успішно.");
