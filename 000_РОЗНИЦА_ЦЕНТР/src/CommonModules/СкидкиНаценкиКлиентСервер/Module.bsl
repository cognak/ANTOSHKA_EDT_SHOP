...
//2026-03-26 sa нужна функция, которая будет окрулглять только переданную сумму
Функция ОкруглитьСуммуПоФискальнымПравилам(СуммаДокумента)	Экспорт
...
//	Округляем до 10 копеек по арифметическим правилам (от 5 к большему)
	...
	// от 25 до 74 округляем до 50
	// от 75 округляем до 0 в большую сторону
	СуммаБезКопеек = Цел(СуммаДокумента);
	СуммаКопеек = (СуммаДокумента - СуммаБезКопеек) * 100;
