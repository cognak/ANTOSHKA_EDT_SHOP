...
//
Процедура СоздатьВерсиюОбъекта(Объект, АвторВерсии = Неопределено, Знач ТипВерсииОбъекта = Неопределено
		, Комментарий = "", УникальныйИдентификаторСтрокой = "", БезусловнаяЗапись = Ложь
	) Экспорт
...
//	Измерения
	...
	ОбменДаннымиПовтИсп.ПолучитьДанныеУзла().Свойство("ЭлементСтруктуры", МенеджерЗаписиВерсииОбъектов.ЭлементСтруктуры);	//	LNK 21.03.2017 14:00:50
...
Функция ОбъектВерсионируется(знач Источник, НомерПоследнейВерсии) Экспорт
	...
	ВариантВерсионирования = ВерсионированиеОбъектовПовтИсп.ВариантВерсионированияОбъекта(Источник.Метаданные().ПолноеИмя());
	...
	Возврат НЕ (ВариантВерсионирования = Перечисления.ВариантыВерсионированияОбъектов.НеВерсионировать
				...
				ИЛИ ВариантВерсионирования = Перечисления.ВариантыВерсионированияОбъектов.ВерсионироватьПриЗаписиАдминистративной
