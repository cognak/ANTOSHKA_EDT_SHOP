...
Процедура ЗаполнитьРегистрФИОФизЛиц(СотрудникСсылка,ПараметрыСотрудника) Экспорт
		...
		НаборЗаписей.Отбор.ФизЛицо.Установить(СотрудникСсылка);
		НаборЗаписей.Отбор.Период.Установить(ТекущаяДатаЗаписи);

		НоваяСтрока = НаборЗаписей.Добавить();
		НоваяСтрока.Период = ТекущаяДатаЗаписи;
		НоваяСтрока.Активность = Истина;
		НоваяСтрока.ФизЛицо = СотрудникСсылка;
		НоваяСтрока.Имя 	= СокрЛП(ПараметрыСотрудника.Имя);
		НоваяСтрока.Фамилия = СокрЛП(ПараметрыСотрудника.Фамилия);
		НоваяСтрока.Отчество = СокрЛП(ПараметрыСотрудника.Отчество);
