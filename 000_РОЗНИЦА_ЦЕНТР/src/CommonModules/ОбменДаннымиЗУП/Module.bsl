...
Процедура ЗаполнитьСправочникКонтрагентаПоСотруднику(ПараметрыСотрудника)
	...
	КонтрагентОбъект.Комментарий = "обновлен из ЗУП "+ТекущаяДатаСеанса();
	...
	//2026-03-16 sa Из-за того что в отделе аналитики не умеют пользоваться Power BI будем заполнять ДР клиента
	...
	//У нового контрагента добавляем виртуальную карту
	Если КонтрагентаНужно.Создавать Тогда

		ИнформационныеКартыСлужебный.ПрисвоитьРезервнуюВиртуальнуюКарту(
