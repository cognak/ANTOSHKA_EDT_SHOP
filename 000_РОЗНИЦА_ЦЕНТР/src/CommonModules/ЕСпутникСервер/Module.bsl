...
Функция ПолучитьПроцентСкидкиКлиента(Контрагент)
	...
	|	ВЫБОР
	|		КОГДА СУММА(ПродажиПоДисконтнымКартамОбороты.СуммаОборот) МЕЖДУ 0 И 6999
	|			ТОГДА 3
	|		КОГДА СУММА(ПродажиПоДисконтнымКартамОбороты.СуммаОборот) МЕЖДУ 7000 И 14999
	|			ТОГДА 5
	|		КОГДА СУММА(ПродажиПоДисконтнымКартамОбороты.СуммаОборот) МЕЖДУ 15000 И 24999
	|			ТОГДА 7
