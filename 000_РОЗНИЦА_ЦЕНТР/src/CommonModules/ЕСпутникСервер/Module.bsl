...
Функция ДобавитьОбновитьКонтрагента(СтруктураВыгрузки) Экспорт 
	...
	Запрос.УстановитьПараметр("Контрагент", СтруктураВыгрузки.ДанныеДляОтправки.Ссылка);
		...
		Иначе
			...
			ИначеЕсли ВРег(ТипОбмена) = "ЗАКАЗЫ" И (ТипЗнч(ДанныеДляОтправки) = Тип("СправочникОбъект.Контрагенты")) Тогда 	
				...
				Если ЭтоКонтрагентРозницы(ДанныеДляОтправки.Ссылка) Тогда 
					ДобавитьОбновитьКонтрагента(СтруктураВыгрузки);
				КонецЕсли;	
