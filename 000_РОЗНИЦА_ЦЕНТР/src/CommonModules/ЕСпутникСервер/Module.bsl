...
Функция ВыгрузкаЕСпутник(СтруктураВыгрузки) 
	...
	Пока ВыборкаСсылка.Следующий() Цикл
		...
		Запрос.Текст = 
			...
			|ИЗ
			|	РегистрНакопления.ПродажиПоЧекам.Обороты(, &КонДата,, ВладелецДисконтнойКарты = &Контрагент) КАК
			|		ПродажиПоЧекамОбороты
			|СГРУППИРОВАТЬ ПО
			...
			|ИЗ
			|	РегистрНакопления.ПродажиПоЧекам.Обороты(&НачДата, &КонДата,, ВладелецДисконтнойКарты = &Контрагент) КАК
			|		ПродажиПоЧекамОбороты
			|;
			|
			|////////////////////////////////////////////////////////////////////////////////
