...
Функция ДобавитьОбновитьКонтрагента(СтруктураВыгрузки, Контрагент) Экспорт 
	...
	JSON.ЗаписатьСвойство("value"				, ?(Контрагент.МаркетинговыеГруппы.Найти(Справочники.МаркетинговыеГруппы.Е_Малятко,"Группа") = Неопределено, "Ні", "Так"), ЗаписьJSONКонтакта);
	ЗаписьJSONКонтакта.ЗаписатьКонецОбъекта();
