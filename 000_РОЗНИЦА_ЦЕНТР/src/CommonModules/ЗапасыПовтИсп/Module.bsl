...
Функция ДанныеМагазинаЦенообразование(Магазин)	Экспорт
	...
	|	ТаблицаСправочник.ВидМинимальныхЦенПродажи,
	|	ТаблицаСправочник.ИспользоватьПрименениеЦен,
	|	ТаблицаСправочник.ПравилоЦенообразования,
	|	ТаблицаСправочник.ФорматМагазина,
...
КонецФункции // ДанныеМагазинаЦенообразование()
