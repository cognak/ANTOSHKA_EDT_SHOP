...
Функция ЗаписатьВерифицированныеДанныеКонтрагента(ДанныеКонтрагента)	Экспорт
	...
	//	---------------------------------------------------------------------------------------
		...
		#Если _ Тогда
		СтрокаКонтакта = КонтрагентОбъект.КонтактнаяИнформация.Добавить();
		#КонецЕсли
...
КонецФункции // ПолучитьСтрокуКонтакта()

Функция СформироватьДанныеТелефона(ПредставлениеТефона, НомерТелефонаБезКодов)
