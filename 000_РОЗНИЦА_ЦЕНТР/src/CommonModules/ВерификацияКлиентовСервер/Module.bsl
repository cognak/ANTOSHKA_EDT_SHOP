...
//			КонецЕсли;
		...
		Иначе
			...
			ИнформационныеКартыСлужебный.ПрисвоитьРезервнуюВиртуальнуюКарту(ДанныеКонтрагента.Контрагент
				, ДанныеКонтрагента.Магазин
				, ОтправкаSMS.ПодготовитьНомерТелефона(ДанныеКонтрагента.НомерТелефона)
	...
	//	Выполним минимальную нормализацию наименования..
		...
		Если ДанныеКонтрагента.Свойство("Комментарий") Тогда 
			КонтрагентОбъект.Комментарий = ДанныеКонтрагента.Комментарий;	
		КонецЕсли;	
