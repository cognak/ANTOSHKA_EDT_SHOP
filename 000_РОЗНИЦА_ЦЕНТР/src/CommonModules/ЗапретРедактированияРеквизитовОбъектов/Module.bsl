...
#Область ПроцедурыУправленияСелективнойДоступностьюЭлементовНекторыхДокументов

//	LNK 23.05.2019 15:08:34
Процедура ЗаблокироватьЭлементыФормы(Элементы, ДанныеИсключений)	Экспорт
	...
	Для каждого Элемент Из Элементы Цикл
		...
		Если ТипЭлемента = Тип("ПолеФормы") ИЛИ ТипЭлемента = Тип("ТаблицаФормы") Тогда
			...
			Если ДанныеИсключений.Получить(Элемент.ПутьКДанным) = Истина Тогда
