...
Функция ИмяОператораВиртуальнойПолки()	Экспорт

	Возврат "Оператор віртуальної полиці";

КонецФункции

//	LNK 01.07.2020 12:18:53
Функция ИмяПользователяВнешнегоСоединения()	Экспорт

	Возврат "Ахромеев Сергей";

КонецФункции

//	LNK 01.07.2020 12:18:53
Функция ИмяПолноеПользователяВнешнегоСоединения()	Экспорт

	Возврат "Ахромеев Сергей Фёдорович";

КонецФункции

//	LNK 01.07.2020 12:20:01
Функция ИмяНеТребуетАвторизации(ИмяПользователя)	Экспорт

	Возврат ИмяПользователя = ИмяОператораВиртуальнойПолки()
		ИЛИ ИмяПользователя = ИмяПользователяВнешнегоСоединения();
