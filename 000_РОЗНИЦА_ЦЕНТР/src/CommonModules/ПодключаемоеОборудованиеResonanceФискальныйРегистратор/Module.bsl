...
//	Печатаем строки чека   
	...
	//	Печатаем строки чека
		...
		//	Закрываем чек
			Результат = ЗакрытьЧек(ОбъектДрайвера, Параметры, ПараметрыПодключения, ТаблицаОплат, ВыходныеПараметры, ОбщиеПараметры[1], ?(ОбщиеПараметры.Количество()= 19, ОбщиеПараметры[18], ""));
