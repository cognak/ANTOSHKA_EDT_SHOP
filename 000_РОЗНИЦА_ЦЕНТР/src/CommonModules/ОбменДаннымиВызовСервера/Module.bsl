...
//	LNK 31.01.2017 13:05:07
Функция ГлавныйУзел()	Экспорт

	Возврат ОбменДаннымиПовтИсп.ГлавныйУзел();

КонецФункции // ГлавныйУзел()

//	LNK 27.01.2017 14:23:21
Функция ЭтоГлавныйУзел(УзелИнформационнойБазы = Неопределено)	Экспорт

	Возврат ОбменДаннымиПовтИсп.ЭтоГлавныйУзел(УзелИнформационнойБазы);

КонецФункции // ЭтоГлавныйУзел()

//	LNK 31.01.2017 12:58:05
Функция ПолучитьДанныеУзла(Знач УзелИнформационнойБазы = Неопределено)	Экспорт

	Возврат ОбменДаннымиПовтИсп.ПолучитьДанныеУзла(УзелИнформационнойБазы);

КонецФункции // ПолучитьДанныеУзла()

//	LNK 17.07.2017 09:50:50
Функция ПолучитьКаталогФайловОбновления()	Экспорт

	Возврат ОбменДаннымиПовтИсп.ПолучитьКаталогФайловОбновления();
