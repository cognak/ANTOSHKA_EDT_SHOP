...
Функция РезультатЗапросаДоступныхУслугБанка(СписокТоваров, КассаККМ, ТипУслуги, ИнтернетБанкинг)
	...
	|	ТаблицаУслуги.РазрешитьСмешаннуюОплату
	...
	|	Предоставить.ВсеТовары КАК ВсеТовары,
	|	Предоставить.РазрешитьСмешаннуюОплату КАК РазрешитьСмешаннуюОплату
	|ИЗ
	|	(ВЫБРАТЬ
	|		УслугиБанка.УслугаБанка КАК УслугаБанка,
	...
	|		УслугиБанка.ВсеТовары,
	|		УслугиБанка.РазрешитьСмешаннуюОплату
	|	ИЗ
	|		Товары КАК Товары
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ УслугиБанка КАК УслугиБанка
