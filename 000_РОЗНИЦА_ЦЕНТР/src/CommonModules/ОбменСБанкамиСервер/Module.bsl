...
// Возвращает структуру ответа от внешней системы.
//
// Возвращаемое значение:
//   Структура:
//     * Отказ - Булево - признак отказа
//     * ТекстСообщения - Строка - текст сообщения
//     * ОтветБанка - Строка - ответ от банка
//     * ДанныеОтветаБанка - Строка - полный ответ от банка
Функция СтруктураОтветаВнешнейСистемы()	Экспорт

	ДанныеОтвета = Новый Структура;
	ДанныеОтвета.Вставить("Отказ", Ложь);
	ДанныеОтвета.Вставить("ТекстСообщения", "");
	ДанныеОтвета.Вставить("ОтветБанка", "");
	ДанныеОтвета.Вставить("ТекстОтвета", "");
