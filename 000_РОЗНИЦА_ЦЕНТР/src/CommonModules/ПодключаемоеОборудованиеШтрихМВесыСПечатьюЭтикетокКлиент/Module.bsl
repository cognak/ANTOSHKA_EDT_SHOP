...
Функция НачатьВыгрузку(ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	ПрефиксШтрихкодаВесовогоТовара   = "2" + ПроцедурыОбменаДаннымиOfflineПереопределяемый.ПолучитьПрефиксВесовогоТовара(Параметры.Идентификатор);
    ПрефиксШтучногоФасованногоТовара = "2" + ПроцедурыОбменаДаннымиOfflineПереопределяемый.ПолучитьПрефиксШтучногоТовара(Параметры.Идентификатор);
