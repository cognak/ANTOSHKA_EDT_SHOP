	...
	//	LNK 27.09.2016 09:29:34
		Если ДанныеЗаполнения.Свойство("Магазин") И ЗначениеЗаполнено(ДанныеЗаполнения.Магазин) Тогда
			...
			Если ДанныеЗаполнения.Свойство("Организация") И ЗначениеЗаполнено(ДанныеЗаполнения.Организация) Тогда
					...
					Касса = Справочники.Кассы.КассаПоУмолчанию(ДанныеЗаполнения.Организация, ДанныеЗаполнения.Магазин);

			Иначе	Касса = ОбщегоНазначенияРТповтИсп.РеквизитыМагазина(ДанныеЗаполнения.Магазин).КассаМагазина;
