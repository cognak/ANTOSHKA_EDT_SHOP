...
Функция ПланыОбменаРИБ() Экспорт
	...
	Результат.Добавить(Метаданные.ПланыОбмена.ПоМагазину.Имя);
	Результат.Добавить(Метаданные.ПланыОбмена.ПоМагазинуКонвертация.Имя);
	Результат.Добавить(Метаданные.ПланыОбмена.ПоРабочемуМесту.Имя);
