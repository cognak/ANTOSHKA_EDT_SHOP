...
Процедура ВыполнитьОперациюСФункциейF(a, b, c, d, X, s, t)
	ВыполнитьОперацию(ПобитовоеИли8_3_10(ПобитовоеИ8_3_10(b, c), ПобитовоеИ8_3_10(ПобитовоеНе8_3_10(b), d)), a, b, X, s, t);
КонецПроцедуры

Процедура ВыполнитьОперациюСФункциейG(a, b, c, d, X, s, t)
	ВыполнитьОперацию(ПобитовоеИли8_3_10(ПобитовоеИ8_3_10(b, d), ПобитовоеИ8_3_10(ПобитовоеНе8_3_10(d), c)), a, b, X, s, t);
КонецПроцедуры
...
Процедура ВыполнитьОперациюСФункциейI(a, b, c, d, X, s, t)
	ВыполнитьОперацию(ПобитовоеИсключающееИли(ПобитовоеИли8_3_10(ПобитовоеНе8_3_10(d), b), c), a, b, X, s, t);
КонецПроцедуры
...
Функция ПобитовоеИ8_3_10(БинарныйМассив1, БинарныйМассив2)
	Результат = Новый Массив;
...
Функция ПобитовоеИли8_3_10(БинарныйМассив1, БинарныйМассив2)
	Результат = Новый Массив;
	Для Индекс = 0 По БинарныйМассив1.Количество()-1 Цикл
...
Функция ПобитовоеНе8_3_10(БинарныйМассив)
	Результат = Новый Массив;
