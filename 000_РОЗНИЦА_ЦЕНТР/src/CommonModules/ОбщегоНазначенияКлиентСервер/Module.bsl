...
// Выполняет паузу выполнения на указанный интервал
//
// Параметры:
//   ИнтервалОжидания - Число - интервал ожидания в миллисекундах, по умолчанию 1 сек.
//   ЭтоТочноWindows - Булево - если Истина, пропускает определение типа платформы и использует код для Windows
