...
Процедура СделатьЗапиьВРССтатусТТН(ПараметрыДляЗаписи)
	...
	Иначе
		...
		СтруктураОтветаЭН.ОтказОтПолучения = ПараметрыДляЗаписи.Свойство("ОтказОтПолучения");
		...
		ВозвратнаяНакладная = ПараметрыДляЗаписи.Свойство("ОтказОтПолучения");
		
	КонецЕсли;
	
	Если ПараметрыДляЗаписи.Свойство("ОтказОтПолучения") И ПараметрыДляЗаписи.ОтказОтПолучения Тогда
	...
	Если Не ЭлектроннаяНакладная.Пустая() Тогда
