...
Функция Обработать_getWarehouses(ЭлементДом,Результат, Владелец, Параметры)
	...
	тзОтделения.Колонки.Добавить("МаксимальныеГабариты");
	...
	ИначеЕсли Отделение.Наименование <>  Строка.Наименование
			...
			ИЛИ Отделение.МаксимальныеГабариты <>  Строка.МаксимальныеГабариты 
...
Функция СформироватьФайл(ТекущийКлюч,ЕНРеф,ИмяФайлаЗаписиНаФТП,ТипДокумента)
	...
	Попытка
		...
		url= "cbone.antoshka.ua/np";
		Соединение=новый HTTPСоединение("cbone.antoshka.ua",,,,,,new ЗащищенноеСоединениеOpenSSL);
