...
Функция ЗапросДляПочты(ДокументЗапроса)
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ТаблицаЗП.СтатусОплаты,
	|	ТаблицаЗП.СуммаОплаты,
	|	ТаблицаЗП.СуммаДоставкиОплачена,
	|	ТаблицаЗП.СуммаДоставкиОператор,
	|	ТаблицаЗП.СуммаДоставки,
	|	ВЫБОР
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ЗаказПокупателя КАК ТаблицаЗП
...
Функция ТТНАдресАдрес(ДокССылка,КлючAPI)  
	...
	Если Выборка.Следующий() Тогда
		...
		ДопУслуги = "<AdditionalInformation>Тестовый</AdditionalInformation>";
