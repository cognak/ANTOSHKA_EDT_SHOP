...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	// Дополнительно ассортиментные варианты, которые включены в 2 раздела
	
	// СтоимостнаяОценкаСклада
	...
	Вариант.Размещение.Удалить(Метаданные.Подсистемы.Маркетинг.Подсистемы.ДополнительныеОтчетыПоАнализуАссортимента);
