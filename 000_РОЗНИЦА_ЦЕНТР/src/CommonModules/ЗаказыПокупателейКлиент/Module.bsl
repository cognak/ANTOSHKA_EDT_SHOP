...
Процедура ОформитьКнопкуИзменениеСтатусаДокумента(ДокументСсылка, Форма, КлючФормы)	Экспорт
	...
	Иначе
		...
		МагазинОтправительЗапроса = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДокументСсылка, "МагазинОтправитель");

		ЗапросДанногоМагазина = (МагазинОтправительЗапроса = ПараметрыРаботыКлиента.ТекущийМагазин)
