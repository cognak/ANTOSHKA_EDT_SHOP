...
Процедура ОформитьКнопкуИзменениеСтатусаДокумента(ДокументСсылка, Форма, КлючФормы)	Экспорт
	...
	Иначе
		...
		РеквизитыОбъекта = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументСсылка, "МагазинОтправитель, ОператорДоставки");

		ЗапросДанногоМагазина = (РеквизитыОбъекта.МагазинОтправитель = ПараметрыРаботыКлиента.ТекущийМагазин)
		...
		ИначеЕсли СледующееСостояние = ПредопределенноеЗначение("Перечисление.СтатусыЗапросовДоступностиТоваровШапка.ВыданДоставке")
				И (РеквизитыОбъекта.ОператорДоставки = ПредопределенноеЗначение("Перечисление.ОператорыДоставки.ВнутренняяЛогистика")
					Или РеквизитыОбъекта.ОператорДоставки = ПредопределенноеЗначение("Перечисление.ОператорыДоставки.ДоставкаКурьером")
					Или РеквизитыОбъекта.ОператорДоставки = ПредопределенноеЗначение("Перечисление.ОператорыДоставки.МеждународнаяДоставка")) Тогда 
