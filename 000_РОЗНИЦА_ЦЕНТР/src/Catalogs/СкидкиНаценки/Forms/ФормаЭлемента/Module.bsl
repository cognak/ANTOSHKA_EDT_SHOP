...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	//2026-09-03 sa убираем способ применения скидок, если тип скидки платежная система.
	//в этом случае скидка назначается по команде платежной системы поверх всех остальных скидок.
	Если Объект.ТипСкидкиНаценки = ПредопределенноеЗначение("Перечисление.ТипСкидкиНаценки.ПлатежнаяСистема") Тогда
		Объект.СпособПримененияСкидки = Неопределено;	
	КонецЕсли;
КонецПроцедуры
...
&НаКлиенте
Процедура ТипСкидкиНаценки1ПриИзменении(Элемент)
	УстановитьВидимость();
КонецПроцедуры
...
Процедура УстановитьВидимость()
	Если Объект.ТипСкидкиНаценки = ПредопределенноеЗначение("Перечисление.ТипСкидкиНаценки.ПлатежнаяСистема") Тогда
		Элементы.ГруппаФормаСкидкиПлатежнаяСистема.Видимость = Истина;
		Элементы.ГруппаФормаСкидки.Видимость = Ложь;
	Иначе
		Элементы.ГруппаФормаСкидкиПлатежнаяСистема.Видимость = Ложь;
		Элементы.ГруппаФормаСкидки.Видимость = Истина;
	КонецЕсли;
