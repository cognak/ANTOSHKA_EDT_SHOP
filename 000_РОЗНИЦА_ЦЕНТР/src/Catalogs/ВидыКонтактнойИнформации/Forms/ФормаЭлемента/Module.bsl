...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЭтоПредопределенный Тогда
		...
		УправлениеКонтактнойИнформацией.ПриБлокировкеРеквизитовОбъекта(ЭтотОбъект);
	КонецЕсли;
...
//	LNK 12.08.2016
	ИначеЕсли НЕ ТехническаяПоддержкаВызовСервера.ИсключительныйРежим() Тогда
...
Процедура АдресТолькоУкраинскийПриИзменении(Элемент)
		...
		ПриИзмененииАдресТолькоУкраинский();
...
Процедура Подключаемый_РазрешитьРедактированиеРеквизитовОбъекта(Команда)
	...
	Если Не ЭтоПредопределенный Тогда
		...
		УправлениеКонтактнойИнформациейКлиент.ПриРазрешенииРедактированияРеквизитовОбъекта(ЭтотОбъект, РедактированиеРазрешено);
		
		Если РедактированиеРазрешено Тогда
			
			УправлениеКонтактнойИнформациейКлиент.ПриУстановкеДоступностиЭлементовФормы(ЭтотОбъект);
...
&НаКлиенте
Процедура ПриИзмененииАдресТолькоУкраинский()
