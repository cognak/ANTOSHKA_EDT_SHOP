...
//
Функция РеквизитыОрганизации(Организация, ДатаСреза = '00010101')	Экспорт

	Если НЕ ПривилегированныйРежим() Тогда	//	LNK 08.04.2024 08:19:20
	...
	|	Организации.Блокирован КАК Блокирован
	|ИЗ
	...
	//СоставРеквизитов = Новый Структура("Представление, Наименование, НаименованиеПолное, ЮрФизЛицо",
	//	Представление,
	//	Наименование,
	//	НаименованиеПолное,
	//	ЮрФизЛицо
...
// Получает организацию, указанную основной в учётной политике.
//
// Возвращаемое значение:
...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	(ОбщегоНазначенияКлиентСервер.ЗначениеКлючаСтруктуры(Параметры, "ПоказатьВсеЭлементы", Ложь) ИЛИ ПараметрыСеанса.ДоступныВсеОрганизации)	Тогда
		...
		|	ТаблицаОрганизаций.Организация.Наименование КАК КлючПорядка
		|ИЗ
