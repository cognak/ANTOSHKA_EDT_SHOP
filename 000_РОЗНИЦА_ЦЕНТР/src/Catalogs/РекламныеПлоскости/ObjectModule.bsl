...
Функция ПроверитьДопустимостьЗаписиОбъекта(Отказ)
		...
		Если НЕ ЕстьРазрешениеИзменения Тогда
			...
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Отказано. Изменения справочника «Рекламные плоскости» запрещены!",,,, Отказ);
...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Если НЕ ЭтоГруппа Тогда
		...
		ФайлКартинки = Справочники.РекламныеПлоскостиПрисоединенныеФайлы.ПустаяСсылка();
