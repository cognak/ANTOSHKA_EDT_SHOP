...
Процедура БлокированПриИзменении(Элемент)
	...
	ОбщегоНазначенияКлиент.УстановитьТолькоПросмотрДляФормы(Элементы,
															Команды,
															Объект.Блокирован,
															"ТипУслуги, Блокирован");
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыНоменклатураИсключения
...
Процедура НоменклатураИсключенияНоменклатураНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	НоменклатураНачалоВыбора(Элемент,
							 Элементы.НоменклатураИсключения.ТекущиеДанные.Номенклатура,
							 ДанныеВыбора,
							 СтандартнаяОбработка);
...
Процедура УстановитьОформлениеЭлементов()
	...
	МгновеннаяРассрочка = (Объект.ТипУслуги
		= ПредопределенноеЗначение("Перечисление.ТипыУслугБанка.МгновеннаяРассрочка"));
	ПакетМалыша = (Объект.ТипУслуги = ПредопределенноеЗначение("Перечисление.ТипыУслугБанка.ПакетМалыша")
		Или Объект.ТипУслуги = ПредопределенноеЗначение("Перечисление.ТипыУслугБанка.ПакетШкольника"));
