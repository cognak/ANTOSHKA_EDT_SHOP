...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РольДоступна("Администрирование") Тогда 
		Элементы.Доступ.Видимость = Истина;
	Иначе
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ОбновитьРолиПринудительно Тогда

		ТекущийОбъект.ДополнительныеСвойства.Вставить("ОбновитьРолиПринудительно", Истина);
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.Свойство("ПредупредитьЧтоПрофильПомеченНаУдаление") Тогда
		...
		ПоказатьПредупреждение(, НСтр("ru = 'Группа доступа не влияет на права участников
