...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	ПолучитьОрганизацию(Объект.Ссылка, Организация);	//	LNK 22.11.2023 18:07:56
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ЗаписьОрганизацииПодразделений"
	И	 ТипЗнч(Параметр) = Тип("Структура")
	И	(Параметр.Магазин = Объект.Ссылка ИЛИ Параметр.Магазин = Неопределено)
	Тогда
...
&НаСервереБезКонтекста	//	LNK 22.11.2023 18:06:34
Процедура ПолучитьОрганизацию(Ссылка, Организация)
