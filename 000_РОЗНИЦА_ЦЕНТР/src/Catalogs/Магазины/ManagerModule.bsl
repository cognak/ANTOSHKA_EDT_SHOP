...
Функция ПолучитьМагазинПоУмолчанию() Экспорт
	...
	Если ОбменДаннымиВызовСервера.ПолучитьДанныеУзла().Свойство("Магазин") Тогда

		Магазин = ОбменДаннымиВызовСервера.ПолучитьДанныеУзла().Магазин;
