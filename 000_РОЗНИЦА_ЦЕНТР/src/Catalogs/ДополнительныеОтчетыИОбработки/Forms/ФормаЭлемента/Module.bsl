...
&НаКлиенте	//	LNK 23.11.2022 08:17:47
Процедура ПереключитьБезопасныйРежим(Команда)

	Объект.БезопасныйРежим = НЕ Объект.БезопасныйРежим;
	Модифицированность = Истина;
	УстановитьВидимостьДоступность();
...
//	LNK 23.11.2022 08:15:58
	Элементы.ПереключитьБезопасныйРежим.Доступность = ТехническаяПоддержкаВызовСервера.ОтладочныйРежимРаботы();
