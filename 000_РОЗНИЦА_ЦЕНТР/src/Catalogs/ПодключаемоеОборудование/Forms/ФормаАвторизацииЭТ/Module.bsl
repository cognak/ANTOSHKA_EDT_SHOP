...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаСтраницы.ТекущаяСтраница = ?(УказатьДополнительныеДанные,
												Элементы.ГруппаСтраницаДополнительныеДанные,
												Элементы.ГруппаСтраницаБезДополнительныхДанных);
												
	ТипыПодключенногоОборудования = МенеджерОборудованияСерверПовтИсп.ТипыПодключенногоОборудования();
	
	ДоступноСчитываниеНаСМК = ТипыПодключенногоОборудования <> Неопределено
...
Процедура ПриОткрытии(Отказ)
	...
	Если ДоступноСчитываниеНаСМК Тогда
		МенеджерОборудованияКлиент.ПодключитьОборудованиеПоТипу(УникальныйИдентификатор, ПоддерживаемыеТипыПО); 
		НадписьДоступноСчитываниеНаСМК = "Доступно считывание карты на считывателе магнитных карт.";
		ЦветНадписи = Новый Цвет();
		Элементы.НадписьДоступноСчитываниеНаСМКСтраница1.Видимость = Истина;
	Иначе
		НадписьДоступноСчитываниеНаСМК = "Считывание карты на считывателе магнитных карт не доступно.";
		ЦветНадписи = WebЦвета.Красный;
	КонецЕсли;
	
	Элементы.НадписьДоступноСчитываниеНаСМКСтраница1.ЦветТекста = ЦветНадписи;
	Элементы.НадписьДоступноСчитываниеНаСМКСтраница2.ЦветТекста = ЦветНадписи;
