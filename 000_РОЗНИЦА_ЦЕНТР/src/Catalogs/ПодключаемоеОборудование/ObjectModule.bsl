...
Процедура ПередЗаписью(Отказ)
	...
	Если НЕ ОбработчикДрайвера = Перечисления.ОбработчикиДрайверовПодключаемогоОборудования.ОбработчикIngenicoECRCommXПриватбанк Тогда

		МетодЧтенияКарты = Неопределено;
