...
///////////////////////////////////////////////////////////////////////////////
// ОБРАБОТЧИКИ СОБЫТИЙ ЭЛЕМЕНТОВ ТАБЛИЧНОЙ ЧАСТИ "КорзинаДерево"
...
Процедура ЗаполнитьКорзину()
	...
	Если ОплатаПоставщику Тогда
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	НеОплаченныеДокументы.ДокументРасчета КАК Документ,
		...
		|		ПО Результат.Документ = РасшифровкаПлатежа.Документ
		|
		|УПОРЯДОЧИТЬ ПО
		|	Результат.Дата";
	...
	Иначе
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	РасчетыСПоставщиками.ДокументРасчета КАК Документ,
		...
		|	РасчетыСПоставщиками.Документ.СуммаДокумента КАК СуммаДокумента,
		|	РасчетыСПоставщиками.Документ.Дата КАК ДокументРасчетаДата
		|ПОМЕСТИТЬ Результат
		|ИЗ
...
Процедура ЗаполнитьКорзинуДерево()
	...
	|		ПО Результат.Документ = Заявки.ДокументРасчетовСКонтрагентом
		...
		Пока ВыборкаПоДокументам.Следующий() Цикл
			...
			Пока Выборка.Следующий() Цикл
				...
				Если ЗначениеЗаполнено(Выборка.Заявка) Тогда
					...
					СтрокаЗаявка.Документ = Выборка.Заявка;
				КонецЕсли;
			КонецЦикла;
