...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если Объект.ТаблицаНеутвержденныхСвязей.Количество() > 0 Тогда
		...
		Если Отказ Тогда
			...
			ПоказатьПредупреждение(, НСтр("ru = 'Возникли ошибки.'"));
...
Процедура Обновить(Команда)
	...
	Если Отказ Тогда
		...
		ПоказатьПредупреждение(, НСтр("ru = 'При выполнении операции сопоставления возникли ошибки.'"));
...
Процедура ВыполнитьАвтоматическоеСопоставление(Команда)
	...
	СписокПолейСопоставления = ОткрытьФормуМодально("Обработка.СопоставлениеОбъектовИнформационныхБаз.Форма.НастройкаАвтоматическогоСопоставления", ПараметрыДляФормы, ЭтотОбъект);
	...
	АдресВременногоХранилища = ОткрытьФормуМодально("Обработка.СопоставлениеОбъектовИнформационныхБаз.Форма.РезультатАвтоматическогоСопоставления", ПараметрыФормы, ЭтотОбъект);
	...
	Если Отказ Тогда
		...
		ПоказатьПредупреждение(, НСтр("ru = 'Во время выполнения автоматического сопоставления возникли ошибки.'"));
...
Процедура ИзменитьПоляТаблицы(Команда)
	...
	СписокПолейФормыНастройки = ОткрытьФормуМодально("Обработка.СопоставлениеОбъектовИнформационныхБаз.Форма.НастройкаПолейТаблицы", ПараметрыДляФормы, ЭтотОбъект);
...
Процедура НастройкаСпискаПолейТаблицы(Команда)
	...
	СписокПолейФормыНастройки = ОткрытьФормуМодально("Обработка.СопоставлениеОбъектовИнформационныхБаз.Форма.НастройкаПолейТаблицыСопоставления", ПараметрыДляФормы, ЭтотОбъект);
...
Процедура Сортировка(Команда)
	...
	ТаблицаСортировкиРезультат = ОткрытьФормуМодально("Обработка.СопоставлениеОбъектовИнформационныхБаз.Форма.НастройкаСортировки", ПараметрыДляФормы, ЭтотОбъект);
...
Процедура УстановитьСвязьИнтерактивно()
	...
	// вызов сервера
	НомерПоПорядкуСтрокиОкончания = ОткрытьФормуМодально("Обработка.СопоставлениеОбъектовИнформационныхБаз.Форма.ФормаВыбораСвязиСопоставления", ПараметрыФормы, ЭтотОбъект);
