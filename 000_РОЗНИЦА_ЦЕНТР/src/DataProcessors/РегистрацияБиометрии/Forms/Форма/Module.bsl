...
Процедура КомандаЗарегистрировать(Команда)
	...
	Если ТекСтрока.Зарегистрирован Тогда
		...
		ФормаРегистрации = ОткрытьФормуМодально("ВнешняяОбработка.РегистрацияБиометрии.Форма.ФормаИдентификации",СтруктураПараметров,ЭтаФорма);
...
Процедура ПриОткрытии(Отказ)
	...
	Если ЕстьПравоДоступаИзменятьБиометрическиеДанные() Тогда
		Отказ = Истина;
