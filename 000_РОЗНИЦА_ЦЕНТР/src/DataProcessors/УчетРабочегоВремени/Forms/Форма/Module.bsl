...
Процедура ПриОткрытии(Отказ)
	//2025-05-26 sa Если используется биометрика, то сканеры ШК отключаем.  
	//2025-05-28 sa Временно отключим
	//Если  ИспользуетсяБиометрическийСканерСервер() Тогда
	//	Отказ = Истина;
	//	Сообщение = Новый СообщениеПользователю;
	//	Сообщение.Текст = "На магазине используется биометрический сканер. Работа со сканером ШК для идентификации сотрудника невозможна!";
	//	Сообщение.Сообщить();
	//	Возврат;
	//КонецЕсли;
