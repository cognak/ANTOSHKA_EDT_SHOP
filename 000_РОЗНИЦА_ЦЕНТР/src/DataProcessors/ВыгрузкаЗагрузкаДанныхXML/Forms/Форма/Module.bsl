...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ДеревоМетаданныхПолноеИмяМетаданных.ТолькоПросмотр = Истина;
...
Процедура ОбработатьНачалоВыбораФайла(СтандартнаяОбработка)
	...
	ФайлДляОбработки = Новый Файл(ДиалогВыбораФайла.ПолноеИмяФайла);
	ДиалогВыбораФайла.Каталог = ФайлДляОбработки.Путь;
	...
	Если ДиалогВыбораФайла.Выбрать() Тогда
		...
		Иначе	ИмяФайлаЗагрузки = ДиалогВыбораФайла.ПолноеИмяФайла;
