...
Процедура СписокВыборЗначения(Элемент, Значение, СтандартнаяОбработка)
	...
	Если РеквизитыВыбора.Статус = ПредопределенноеЗначение("Перечисление.СтатусыЗаказовПокупателей.Отменён")
	ИЛИ	 РеквизитыВыбора.СтатусИМ = ПредопределенноеЗначение("Перечисление.СтатусыИнтернетМагазина.canceled")
	Тогда
		...
		ОбщегоНазначенияРТКлиент.ВывестиИнформациюДляРМК(
			...
			, "Заборонено оформлення продажу на замовлення у статусі «Скасовано»!"
			,
			, ЭтотОбъект
		);
		СтандартнаяОбработка = Ложь;

	ИначеЕсли РеквизитыВыбора.СтатусОплаты = ПредопределенноеЗначение("Перечисление.СтатусОплаты.НеОплачен")
	И		  РеквизитыВыбора.ТипДоставки = ПредопределенноеЗначение("Перечисление.ТипДоставкиЗаказПокупателя.Самовывоз")
	Тогда
