...
Процедура УстановитьОформлениеЭлементов()	Экспорт	//	при передаче бонусов
	...
	Если НаборПравИНастроек.ИспользоватьБонуснуюСистему Тогда
		...
		СоединениеУстановлено = УстановитьСуммуПокупок(Неопределено);	//	LNK 01.09.2023 08:15:41
...
//	---------------------------------------------------------------------------------------
	...
	УстановитьСуммуПокупок(ДанныеКарты.СуммаПокупок);	//	LNK 01.09.2023 08:07:37
...
Функция УстановитьСуммуПокупок(СуммаПокупок, Обнулить = Ложь)
	...
	Иначе
		...
		РМК2_СуммаНакоплений = РМК2_СуммаПокупок;
