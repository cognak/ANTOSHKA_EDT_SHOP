...
//	Пропускаем инициализацию, чтобы гарантировать получение формы при передаче параметра "АвтоТест".
	...
	ПараметрыКассыККМ = ЗначениеНастроекПовтИсп.ПолучитьПараметрыКассыККМ(ТекКассаККМ);	//	LNK 03.01.2024 08:07:26
	...
	Элементы.РасширенныйПериодескийОтчет.Видимость = ЭтоПРРО;
