...
//	Пропускаем инициализацию, чтобы гарантировать получение формы при передаче параметра "АвтоТест".
	...
	Параметры.Свойство("СуммаБонусовДляСписания"	, СуммаБонусовДляСписания);
...
//	LNK 18.06.2021 10:10:51
	...
	Если Не СуммаБонусовДляСписания = 0 Тогда
		
		СуммаБонусныхБалловОплатить = СуммаБонусовДляСписания;
...
//	ДеревоНакоплений.ПолучитьСтроки() - коллекция строк
	...
	ПараметрыЗапроса.Вставить("Магазин", Магазин);
	ПараметрыЗапроса.Вставить("ТоварыДляОплаты", ТоварыДляОплаты.Выгрузить());
	ПараметрыЗапроса.Вставить("ПрограммаЛояльности");
	ПараметрыЗапроса.Вставить("ТипыБонусов", ОбщегоНазначенияКлиентСервер.AAD(Перечисления.ТипыБонусов.Привлечение, Перечисления.ТипыБонусов.Органический));
	ПараметрыЗапроса.Вставить("ТолькоТекущийОстаток", Ложь);
