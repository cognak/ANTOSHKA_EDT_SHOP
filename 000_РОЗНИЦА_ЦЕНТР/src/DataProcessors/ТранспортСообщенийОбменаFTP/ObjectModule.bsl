...
//Удалить файл обмена после успешного обмена
Процедура УдалитьФайлОбмена() Экспорт
	...
	Для Каждого СтрокаФайлаОбмена Из ТаблицаФайловСообщенийОбмена Цикл
		
		ФайлВходящегоСообщения = СтрокаФайлаОбмена.Файл;
		
		ВыполнитьУдалениеФайлаНаFTPСервере(ФайлВходящегоСообщения.Имя);
