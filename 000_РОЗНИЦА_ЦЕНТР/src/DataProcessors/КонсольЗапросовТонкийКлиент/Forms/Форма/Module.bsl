...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЖурналСобытий.Регистрация("Консоль запросов (ТК)", УровеньЖурналаРегистрации.Примечание
	, Метаданные.Обработки.КонсольЗапросовТонкийКлиент,,, "Открытие консоли запросов",, Ложь);
