...
Процедура ПриОткрытии(Отказ)
	...
	Для каждого Окно_ из Окна_ Цикл
		Если Окно_.Заголовок = "Реєстрація біометрії" Тогда
			Отказ = Истина;

			ПоказатьОповещениеПользователя("Перевірка можливості користування обробкою"
			,, "У вас відкрита обробка Реєстрації біометричних даних!"+Символы.ПС+"Треба її закрити щоб маєти можливість використовувати обробку для табелювання персоналу!"
