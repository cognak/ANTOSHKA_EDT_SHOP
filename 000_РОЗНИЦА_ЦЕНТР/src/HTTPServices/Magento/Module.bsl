...
Функция ОбновитьКлиента(Клиент)
		...
		Иначе
			Имя_ = ОписаниеКлиента.ClientFirstName;
		КонецЕсли;
		...
		Иначе
			...
			Фамилия_ = ОписаниеКлиента.ClientLastName;
		КонецЕсли;
		...
		Иначе
			Отчество_ = ОписаниеКлиента.ClientMiddleName;
		КонецЕсли;
			...
			Для Каждого Ребенок Из Дети Цикл
				...
				Иначе
					Если Ребенок.Свойство("ChildFirstName")Тогда
						СтрокаРебенок = КонтрагентОбъект.Дети.Найти(Ребенок.ChildFirstName,"Имя");
