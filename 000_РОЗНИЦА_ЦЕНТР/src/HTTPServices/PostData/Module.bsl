...
Функция TTNPOST(ЗапросСервиса)
	...
	ИначеЕсли ДанныеОЗапросе.ВнутренняяЛогистика Тогда
		...
		ДокументСтикер = Документы.ЗапросДоступностиТоваров.СтикерДляВнутреннейЛогистики(ДанныеОЗапросе.СсылкаНаЗапрос);
		...
		ИмяФайлаЗаписиНакладной = "InternalLogistics"+СокрЛП(Результат.order)+".pdf";
