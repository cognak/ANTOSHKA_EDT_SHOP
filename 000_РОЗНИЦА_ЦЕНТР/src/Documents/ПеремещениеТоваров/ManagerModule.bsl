...
//	LNK 06.08.2021 09:45:02
Функция ПолучитьДатуПоОрдеру(Знач ДатаОрдера)	Экспорт
...
Функция ПечатьТТН(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	...
	|	ЕСТЬNULL(ТаблицаОрганизаций.Организация.Префикс, """") КАК Префикс,
	...
	|		ПО ПеремещениеТоваров.МагазинОтправитель = ТаблицаОрганизаций.Владелец
	|ГДЕ
	|	ПеремещениеТоваров.Ссылка В(&МассивДокументов)
	|
	|УПОРЯДОЧИТЬ ПО
