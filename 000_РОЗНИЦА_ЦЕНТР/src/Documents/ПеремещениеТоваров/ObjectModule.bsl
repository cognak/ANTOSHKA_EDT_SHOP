...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	ИначеЕсли ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ЗапросДоступностиТоваров") Тогда 
		...
		Если Не ДанныеЗаполнения.СтатусЗапроса = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.КОтправке Тогда
		...
		Если ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДанныеЗаполнения.МагазинОтправитель, "СкладУправляющейСистемы", Ложь, Ложь)
				Или ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДанныеЗаполнения.МагазинПолучатель, "СкладУправляющейСистемы", Ложь, Ложь) 
				Или Не ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДанныеЗаполнения.МагазинОтправитель, "ВведенВЭксплуатацию", Ложь, Ложь)
				Или Не ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДанныеЗаполнения.МагазинПолучатель, "ВведенВЭксплуатацию", Ложь, Ложь) Тогда
		...
		Если Не ПеремещениеУжеЕсть Тогда
			...
			|	ТаблицаДокумента.МагазинОтправитель.СкладПродажи.IDN КАК МагазинОтправительIDN,
