...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, ДополнительныеСвойства)	Экспорт
	...
	|ИЗ
	|	Документ.УстановкаЛимитовРучныхСкидокРегион КАК ДанныеДокумента
	|ГДЕ
	...
	|ПОМЕСТИТЬ Источник
	|ИЗ
	|	Документ.УстановкаЛимитовРучныхСкидокРегион.Лимиты КАК ТаблицаДокументы
	|ГДЕ
	...
	ТаблицыДляДвижений.Вставить("ТаблицаЛимитыРучныхСкидокУстановлены", Результаты[2].Выгрузить());
