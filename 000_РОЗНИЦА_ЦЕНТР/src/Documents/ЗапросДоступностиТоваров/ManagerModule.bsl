				...
				Пока ВыборкаТоварыЗПОператорДоставки.Следующий() Цикл 
					...
					Пока ВыборкаТоварыЗПМагазинПолучатель.Следующий() Цикл 
						...
						Пока Выборка.Следующий() Цикл 
							...
							Если (ТипЗнч(ДокументОбъект.МагазинОтправитель) = Тип("СправочникСсылка.Склады") 
										И ДокументОбъект.МагазинОтправитель.НазначениеСклада = Перечисления.НазначенияСкладов.УправляющаяСистема)
						...
						Если Не ДокЗаказа.Статус = Перечисления.СтатусыЗаказовПокупателей.Новый
							...
							Если ДокументИзмененСтатус Тогда
								Если ДокументОтменён Тогда
									ДокументОбъект.СтатусЗапроса = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.СтатусОтменыДокумента(ДокументОбъект.СтатусЗапроса);
								Иначе
