...
Процедура СтатусыЗапросовДоступностиПриАктивизацииСтроки(Элемент)
	...
	Если СтатусЗапроса = ПредопределенноеЗначение("Перечисление.СтатусыЗапросовДоступностиТоваровШапка.Новый")
			...
			Или СтатусЗапроса = ПредопределенноеЗначение("Перечисление.СтатусыЗапросовДоступностиТоваровШапка.ПодтвердитьОтмену")
...
Процедура ЗаполнитьТЗСтатусовЗапросаДоступности()  
	...
	Запрос.Текст = 
		...
		|	ИЛИ ЗДТоваров.СтатусЗапроса = ЗНАЧЕНИЕ(Перечисление.СтатусыЗапросовДоступностиТоваровШапка.ПодтвердитьОтмену)
