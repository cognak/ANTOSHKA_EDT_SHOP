...
Процедура СтатусыЗапросовДоступностиПриАктивизацииСтроки(Элемент)
	...
	ИначеЕсли СтатусЗапроса = ПредопределенноеЗначение("Перечисление.СтатусыЗапросовДоступностиТоваровШапка.Отправлен")
...
Процедура ЗаполнитьТЗСтатусовЗапросаДоступности()  
	...
	Запрос.Текст = 
		...
		|	ЗапросДоступностиТоваров.ДокументОснование КАК ДокументОснование,
		...
		|			ТОГДА НЕ ЗапросДоступностиТоваров.МагазинПолучатель = УчетнаяПолитикаСрезПоследних.ИнтернетМагазин
		|		ИНАЧЕ ИСТИНА
		|	КОНЕЦ)))
		|;
		|
