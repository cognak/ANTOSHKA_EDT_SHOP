...
Процедура СтатусыЗапросовДоступностиПриАктивизацииСтроки(Элемент)
	...
	ЗапросыДоступности.Параметры.УстановитьЗначениеПараметра("Магазин", ДанныеДляЗапроса().Магазин);
	ЗапросыДоступности.Параметры.УстановитьЗначениеПараметра("УзелМагазина", ДанныеДляЗапроса().УзелМагазина);
