...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Комментарий = "Состояние обмена - " + ОбменДанными.Загрузка
					+ "Ссылка.ВерсияИМ - " + Ссылка.ВерсияИМ + Символы.ПС
					+ "ВерсияИМ - " + ВерсияИМ + Символы.ПС
					+ "Ссылка.ВерсияП - " + Ссылка.ВерсияП + Символы.ПС
					+ "ВерсияП - " + ВерсияП;
		
	ЗаписьЖурналаРегистрации("ЗапросДоступности", УровеньЖурналаРегистрации.Предупреждение, ЭтотОбъект, , Комментарий);
