...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
		...
		Для Каждого СтрокаТЧ Из Товары Цикл 
			...
			Если ПустаяСтрока(СтрокаТЧ.Примечание) Тогда 
				...
				ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
					...
					ЭтотОбъект,
					ОбщегоНазначенияКлиентСервер.ПутьКТабличнойЧасти("Товары", СтрокаТЧ.НомерСтроки, "Примечание"),
					,
					Отказ
					); 
	...
	Если СтатусЗапроса = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.Закрыт
		И СтатусЗапроса = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.Отменён
		И СтатусЗапроса = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.Удалён
		И СтатусЗапроса = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.ПодтвердитьОтмену Тогда
			
		СкидкиНаценкиКлиентСервер.ОкруглитьТоварыПоСуммеДокумента(СуммаДокумента, Товары, Истина)
...
Процедура ПриЗаписи(Отказ) 
	...
	Если РозничныеПродажиСервер.ЭтоУзелИнтернетМагазина()
