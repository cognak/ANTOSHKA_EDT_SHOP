...
&НаСервере	//	LNK 10.09.2016 10:16:14
...
//Процедура - обработчик команды формы "ВвестиПодарочныеСертификаты"
//
&НаКлиенте
...
//Процедура - обработчик команды "ЗаполнитьПоСебестоимости"
//
&НаКлиенте
...
//Процедура - обработчик команды "ЗаполнитьЦеныВыделенныхСтрокПоСебестоимости"
//
&НаКлиенте
...
//Процедура - обработчик команды "ОткрытьПодбор"
//
&НаКлиенте
...
Процедура ПриИзмененииСклада()
	...
	Если НЕ ЗначениеЗаполнено(Объект.Организация) Тогда
		...
		Объект.Организация = Справочники.Склады.РеквизитыСклада(Объект.Склад, Объект.Дата).Организация;	//	LNK 16.11.2023 05:00:42		
