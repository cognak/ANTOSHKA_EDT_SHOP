...
Процедура УстановитьСуммуНаличнойОплатыИСдачи(ИнформацияПодвала, СуммаДокумента, ТаблицаПоТипамОплат, ПРРО, ШиринаЛенты = 25)
	...
	Если Сдача > 0 Тогда
		...
		ИнформацияПодвала = ИнформацияПодвала + Символы.ПС
		+ ПодготовитьСтроку("Отримано готівкою " + Символы.Таб + Формат(СуммаНаличных, "ЧДЦ=2") + " грн", ШиринаЛенты) + Символы.ПС
		+ ПодготовитьСтроку("Решта готівкою " + Символы.Таб + Формат(Сдача, "ЧДЦ=2") + " грн", ШиринаЛенты);
