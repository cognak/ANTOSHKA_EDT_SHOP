...
Функция ПолучитьФискальныйНомер(ЧекСсылка) Экспорт
	СтруктураОтвета = Новый Структура("ФискальныйНомер,ФискальныйРегистратор","","");
...
Функция ПолучитьПлатежныеРеквизиты(ЧекККМСсылка) Экспорт
	...
	Если Результат.Следующий() Тогда
		...
		СтруктураОтвета.term_id = Результат.РегистрационныйНомер;
...
Функция  РазобратьСлипЧек(СлипЧек)
	 СтруктураСлипЧека = Новый Структура("bank_name,paysys,cardmask,auth_code,rrn","","","","","");
