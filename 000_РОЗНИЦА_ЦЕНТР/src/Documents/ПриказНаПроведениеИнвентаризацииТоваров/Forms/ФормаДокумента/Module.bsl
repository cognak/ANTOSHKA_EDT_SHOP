...
&НаКлиенте	//	LNK 17.11.2023 12:58:40
Процедура МагазинПриИзменении(Элемент)

	РеквизитыМагазина = ОбщегоНазначенияРТКлиент.РеквизитыМагазина(Объект.Магазин, Объект.Дата);
...
Процедура СкладПриИзмененииСервер()
	...
	РеквизитыСклада = ОбщегоНазначенияРТповтИсп.РеквизитыСклада(Объект.Склад, Объект.Дата);	//	LNK 15.11.2023 18:15:40
