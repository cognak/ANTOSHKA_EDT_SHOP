...
Процедура ЗаполнитьОператоровДоставки()
	...
	Элементы.ОператорДоставки.СписокВыбора.Добавить(Перечисления.ОператорыДоставки.ДоставкаКурьером, "Доставка кур'єром.");		
	Элементы.ОператорДоставки.СписокВыбора.Добавить(Перечисления.ОператорыДоставки.МеждународнаяДоставка, "Міжнародна доставка");		
