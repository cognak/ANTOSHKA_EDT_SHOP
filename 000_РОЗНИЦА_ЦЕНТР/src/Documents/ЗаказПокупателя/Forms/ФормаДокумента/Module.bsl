...
Процедура ОбновитьИтоговыеПоказатели(Форма)
	...
	Если Не Форма.Объект.СуммаДоставкиВРучную
			 И Не Форма.Объект.СуммаДоставкиОплачена
			 И Не Форма.Объект.ТипДоставки = ПредопределенноеЗначение("Перечисление.ТипДоставкиЗаказПокупателя.Самовывоз") Тогда
		Если Форма.СуммаВсего >= 1000 И Не Форма.Объект.СуммаДоставки = 0 Тогда
			Форма.Объект.СуммаДоставки = 0;
			Форма.Модифицированность = Истина;
		ИначеЕсли Не Форма.Объект.СуммаДоставки = 59 Тогда
