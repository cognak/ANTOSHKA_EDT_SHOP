...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Если Объект.ТипОплаты = ПредопределенноеЗначение("Перечисление.ТипОплатыЗаказПокупателя.БРПредоплата") 
			Или Объект.ТипОплаты = ПредопределенноеЗначение("Перечисление.ТипОплатыЗаказПокупателя.БРПостоплата") Тогда
...
Процедура ОтправитьСообщениеМагазинам(Команда)
	Если Не Объект.Товары.Количество() = 0 Тогда
		...
		МассивТоваров = ПолучитьСписокТоваров();
		СписокТоваров = Новый СписокЗначений();
		СписокТоваров.Добавить(МассивТоваров);
