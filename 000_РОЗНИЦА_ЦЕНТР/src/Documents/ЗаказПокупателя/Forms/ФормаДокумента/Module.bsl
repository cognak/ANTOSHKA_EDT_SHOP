...
Функция ДобавитьНайденныеСерийныеНомера(МассивНомеров) 
	...
	СтруктураОтбора.Вставить("СкидочныйКупон",МассивНомеров[0].Владелец); 
	...
	Иначе
		...
		ТекущаяСтрока.СкидочныйКупон = МассивНомеров[0].Владелец;  
		ТекущаяСтрока.СерийныйНомер = МассивНомеров[0].Ссылка; 
		ТекущаяСтрока.НоминалКупона = МассивНомеров[0].Владелец.Номинал;
