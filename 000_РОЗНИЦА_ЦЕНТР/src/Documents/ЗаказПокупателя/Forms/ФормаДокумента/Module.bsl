...
Процедура ТоварыНоменклатураПриИзменении(Элемент)
	...
	ИНаче
		...
		ТекущаяСтрока.ЦеныCompeteraОтвет = "На товар IDN " +IDN + Строка(ТекущаяДата()) +" получена цена от Competera "+ Строка(Цена);
		//СтрокаКомментария = "На товар IDN " +IDN + Строка(ТекущаяДата()) +" получена цена от Competera "+ Строка(Цена);
		//ТекущаяСтрока.ЕстьКомментарий = Истина;
		//ТекущаяСтрока.КомментарийПоСтроке = ТекущаяСтрока.КомментарийПоСтроке + " " +СтрокаКомментария;
	КонецЕсли;	
	СтруктураПараметровСтавкиНДС = Новый Структура;
	СтруктураПараметровСтавкиНДС.Вставить("Дата"       , Объект.Дата);
	СтруктураПараметровСтавкиНДС.Вставить("Организация", Объект.Организация);
