...
Процедура ОтобразитьРасчетныеКолонки(НачальныйВызов = Ложь)
	...
	ОтобразитьРасчетнуюКолонку(ДлинныеИменаНоменклатуры(), "ПолноеНаименованиеТовара");
...
&НаСервере
Функция ДлинныеИменаНоменклатуры()
	...
	Запрос.Текст = 
		...
		|	ЗаказПокупателяТовары.КлючСвязиЗапросаДоступности
		|ИЗ
		|	Документ.ЗаказПокупателя.Товары КАК ЗаказПокупателяТовары
	...
	Пока Выборка.Следующий() Цикл
		...
		Результат.Добавить(Новый Структура("КлючСвязиЗапросаДоступности, ПолноеНаименованиеТовара"
					, Выборка.КлючСвязиЗапросаДоступности
