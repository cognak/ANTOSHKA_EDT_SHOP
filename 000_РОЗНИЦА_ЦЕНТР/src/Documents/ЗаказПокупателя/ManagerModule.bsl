...
Функция ПечатьТоварнаяНакладная(МассивОбъектов, ОбъектыПечати, ПараметрыВывода)
	...
	|	ЗаказПокупателя.Дата КАК Дата,
	|	ЗаказПокупателя.Город КАК Город,
	|	ЗаказПокупателя.Улица КАК Улица,
	|	ЗаказПокупателя.Дом КАК Дом,
	|	ЗаказПокупателя.Квартира КАК Квартира,
	|	ЗаказПокупателя.Фамилия + "" "" + ЗаказПокупателя.Имя + "" "" + ЗаказПокупателя.Отчество КАК Получатель,
	...
	|	ЗаказПокупателя.СуммаДоставки КАК Доставка,
	...
	|		И ЗаказПокупателя.Контрагент = КонтрагентыТелефон.Ссылка)
	...
	|		И ЗаказПокупателя.Контрагент = КонтрагентыПочта.Ссылка)
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПолучательМагазин КАК ПолучательМагазин
	|		ПО (ЗаказПокупателя.Ссылка = ПолучательМагазин.Ссылка)
	|ГДЕ
	...
	|	ЗаказПокупателяТовары.Номенклатура.НаименованиеПолное КАК НоменклатураПредставление,
...
Функция ПечатьСчетФактура(МассивОбъектов, ОбъектыПечати, ПараметрыВывода)
	...
	ТабличныйДокумент  = Новый ТабличныйДокумент;
	СинонимДокумента   = НСтр("ru='Счет-фактура';uk='Рахунок-фактура'", КодЯзыкаПечать);
