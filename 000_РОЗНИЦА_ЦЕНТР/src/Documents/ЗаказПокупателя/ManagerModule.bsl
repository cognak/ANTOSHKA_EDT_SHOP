...
Функция ИнформацияОбОплате(СсылкаНаДокумент) Экспорт
	...
	Если Выборка.Следующий() Тогда
		Результат.КоличествоСтрок = Выборка.КоличествоСтрок;
		Результат.КоличествоОтменённых = Выборка.КоличествоОтменённых;
		Результат.ТипОплаты = Выборка.ТипОплаты;
		Результат.ПоследнийНомерОплаты = Выборка.ПоследнийНомерОплаты;
...
Функция ТекстЗапросДляПечати()
	...
	ТекстЗапроса = 
		...
		|		И ТаблицаСчетов.СчетПоУмолчанию
		|ГДЕ
