...
Процедура ОбработкаПолученияПолейПредставления(Поля, СтандартнаяОбработка)
	...
	Поля.Добавить("ВозвратнаяНакладная");
	Поля.Добавить("ПереадресацияНакладная");
...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Представление = "Электронная накладная "
		+ ?(Данные.ВозвратнаяНакладная, "(ВЗВ)", ?(Данные.ПереадресацияНакладная, "(ПА)", ""))
		+ " "
