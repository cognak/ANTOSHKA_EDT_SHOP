...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("УИФормы") Тогда
...
Процедура ОтображениеЭлементов()
	...
	Элементы.ВозвратнаяНакладная.ТолькоПросмотр = ВозможностьРедактировать;
	Элементы.ПереадресацияНакладная.ТолькоПросмотр = ВозможностьРедактировать;
	Элементы.Упаковки.ТолькоПросмотр = ВозможностьРедактировать;
