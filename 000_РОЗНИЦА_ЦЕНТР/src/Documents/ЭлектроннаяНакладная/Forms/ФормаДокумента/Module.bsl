...
Процедура ОтображениеЭлементов()
	...
	Элементы.ФормаСоздатьНакладную.Видимость = ПустаяСтрока(Объект.ВнешняяСсылка) И Не ПосылкаОтменена;

	Элементы.ПерезаполнитьДокумент.Видимость = ПустаяСтрока(Объект.ВнешняяСсылка) И Не ПосылкаОтменена;

	Элементы.ФормаПолучитьДокументы.Видимость = Не ПосылкаОтменена;
