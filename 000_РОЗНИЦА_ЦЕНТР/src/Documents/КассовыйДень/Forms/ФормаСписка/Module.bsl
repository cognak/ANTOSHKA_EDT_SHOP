...
//	Обработчик подсистемы "Внешние обработки"
	...
	Иначе
		Магазин = ПолучитьМагазинИзНастроекПользователя();
	КонецЕсли;
...
&НаСервере
Функция ПолучитьМагазинИзНастроекПользователя()
	Запрос = Новый Запрос;
...
Процедура ПриОткрытии(Отказ)
	...
	Элементы.МагазинОтбор.КнопкаОткрытия = ТехническаяПоддержкаВызовСервера.ИсключительныйРежим();
