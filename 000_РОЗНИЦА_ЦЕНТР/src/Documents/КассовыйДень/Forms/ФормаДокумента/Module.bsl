...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтоИнтернетМагазин = ОбменДаннымиПовтИсп.ПолучитьДанныеУзла().Магазин = ОбщегоНазначенияРТповтИсп.ПолучитьУчетнуюПолитику().ИнтернетМагазин;

	Если НЕ ЭтоИнтернетМагазин Тогда
...
Процедура РегистрацияПередачиВNavisionПовторнаяНажатие(Элемент)
	...
	ВнешниеИсточникиКлиент.ПодтвердитьПовторнуюВыгрузкуВNavision(ЭтотОбъект, Истина);
...
Процедура РегулярнаяПроверкаКнопкиУчестьВNavision()
	...
	Если НЕ ЭтоИнтернетМагазин Тогда	//	LNK 27.12.2023 12:14:26
