...
Функция ПодготовитьСтруктуруДанных(МассивДокументов, МассивНепроведенныхДокументов)
	...
	Запрос.Текст ="ВЫБРАТЬ
	              ...
	              |	СРЕДНЕЕ(Товары.ПроцентУценки) КАК ПроцентУценки,
	              |	СУММА(Товары.СуммаУценки) КАК СуммаУценки,
	              |	Товары.ПричинаУценки КАК ПричинаУценки,
	              |	Товары.Цена КАК ЦенаСтарая,
	              |	Товары.ЦенаПослеУценки КАК Цена
	              |ИЗ
	              |	Документ.УценкаТоваров.Товары КАК Товары
	              |ГДЕ
	              ...
	              |	Товары.Упаковка,
	              |	Товары.ПричинаУценки,
	              |	Товары.Цена,
	              |	Товары.ЦенаПослеУценки
	              |;
	              |
	              |////////////////////////////////////////////////////////////////////////////////
	              |ВЫБРАТЬ РАЗЛИЧНЫЕ
	              ...
	              |ИЗ
	              |	Документ.УценкаТоваров КАК Шапка
	              |ГДЕ
	              ...
	              |////////////////////////////////////////////////////////////////////////////////
	              |ВЫБРАТЬ
	              |	УценкаТоваров.Ссылка
	              |ИЗ
	              |	Документ.УценкаТоваров КАК УценкаТоваров
	              |ГДЕ
	              |	УценкаТоваров.Ссылка В(&МассивДокументов)
	              |	И НЕ УценкаТоваров.Ссылка В (&МассивНепроведенныхДокументов)";
	...
	СтруктураДействий.Вставить("ЗаполнитьДанныеПоУценке");
