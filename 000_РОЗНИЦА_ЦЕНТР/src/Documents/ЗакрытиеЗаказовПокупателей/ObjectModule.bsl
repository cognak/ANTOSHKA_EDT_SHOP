...
Процедура ЗакрытьЗаказыПоСтатусу(РеестрЗаказовПокупателей, Отказ)
	...
	Если ДополнительныеСвойства.Свойство("РежимОчисткиЗакрытиеЗаказовПокупателей")
	И	 ДополнительныеСвойства.РежимОчисткиЗакрытиеЗаказовПокупателей = Истина
	Тогда

		Возврат;	//	LNK 08.05.2023 06:19:34
