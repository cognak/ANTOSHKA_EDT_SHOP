...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	КонецЕсли;
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_ПрепроводительнаяВедомостьКСумке_ВСТ_банк") Тогда
		
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "ПФ_MXL_ПрепроводительнаяВедомостьКСумке_ВСТ_банк",
				"Препроводительная ведомость к сумке",
				СформироватьПечатнуюФормуПрепроводительнаяВедомостьКСумкеВСТ_банк(МассивОбъектов, ОбъектыПечати, ПараметрыПечати));
	
	
	КонецЕсли;
КонецПроцедуры
 
Функция СформироватьПечатнуюФормуПрепроводительнаяВедомостьКСумкеВСТ_банк(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	
	Макет = УправлениеПечатью.ПолучитьМакет("Документ.РасходныйКассовыйОрдер.ПФ_MXL_ПрепроводительнаяВедомостьКСумке_ВСТ_банк");
	...
	Запрос.Текст = "ВЫБРАТЬ РАЗРЕШЕННЫЕ
	               ...
	               |	""інкасатора АТ """"ВСТ банк"""" "" КАК НаименованиеИнкассатора,
	               |	""сейф-пакет"" КАК ВидУпаковкиПриИнкассации,
	               |	РасходныйКассовыйОрдер.Организация.КодПоЕДРПОУ КАК КодПоЕДРПОУ,
	               |	РасходныйКассовыйОрдер.БанковскийСчет.Банк.Наименование КАК ПолучательИнкассации
	               |ИЗ
	               |	Документ.РасходныйКассовыйОрдер КАК РасходныйКассовыйОрдер
	               |ГДЕ
