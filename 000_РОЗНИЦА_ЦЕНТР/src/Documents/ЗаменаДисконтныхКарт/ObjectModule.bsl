...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	НайденнаяСтрокаНеЗаполненаИнформационнаяКарта = КартыПокупателей.Найти(Справочники.ИнформационныеКарты.ПустаяСсылка(), "КартаИсточник, КартаПриемник");
	Если НайденнаяСтрокаНеЗаполненаИнформационнаяКарта = Неопределено Тогда
...
Процедура ВыполнитьОперацииПоДисконтнымКартам(Отказ)
	...
	Для каждого СтрокаТаблицы Из ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаБлокироватьИнформационныеКарты Цикл

		КартаОбъект = СтрокаТаблицы.ИнформационнаяКарта.ПолучитьОбъект();
