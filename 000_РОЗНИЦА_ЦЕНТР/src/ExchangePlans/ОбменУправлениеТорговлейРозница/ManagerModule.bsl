...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат "Настройки обмена УТ3.0-РТ2.0";
...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат "Создать новую синхронизацию данных с конфигурацией ""Управление торговлей для Украины, ред. 3.0""";
...
Функция КраткаяИнформацияПоОбмену() Экспорт
	...
	ПоясняющийТекст = НСтр("ru = 'Позволяет синхронизировать данные между конфигурацией Розница для Украины ред. 2.0 и Управление Торговлей для Украины ред. 3.0. 
...
Функция НастройкаОтборовНаУзлеБазыКорреспондента() Экспорт
	...
	СтруктураТабличнойЧастиВидыЦен.Вставить("ВидЦен",      			Новый Массив);
	СтруктураТабличнойЧастиВидыЦен.Вставить("ВидЦен_Ключ", 			Новый Массив);
	
	СтруктураТабличнойЧастиКассыМагазинов = Новый Структура;
	СтруктураТабличнойЧастиКассыМагазинов.Вставить("Касса",         Новый Массив);
	СтруктураТабличнойЧастиКассыМагазинов.Вставить("Касса_Ключ",    Новый Массив);
	...
	СтруктураТабличнойЧастиСоответствияАналитикиОбмена = Новый Структура;
	СтруктураТабличнойЧастиСоответствияАналитикиОбмена.Вставить("Магазин",      Новый Массив);
	СтруктураТабличнойЧастиСоответствияАналитикиОбмена.Вставить("Магазин_Ключ", Новый Массив);
	...
	СтруктураТабличнойЧастиМагазины.Вставить("Магазин_Ключ",        Новый Массив);
...
Функция ЗначенияПоУмолчаниюНаУзлеБазыКорреспондента() Экспорт
	...
	СтруктураНастроек.Вставить("РежимВыгрузкиПриНеобходимости", Перечисления.РежимыВыгрузкиОбъектовОбмена.ВыгружатьПриНеобходимости);
	СтруктураНастроек.Вставить("СтатьяДоходов",					"");
	СтруктураНастроек.Вставить("СтатьяРасходов", 				"");
	СтруктураНастроек.Вставить("Соглашение", 					"");
	СтруктураНастроек.Вставить("ГруппаДоступаНоменклатуры",		"");
		
	СтруктураНастроек.Вставить("СтатьяДоходов_Ключ",			"");
	СтруктураНастроек.Вставить("СтатьяРасходов_Ключ", 			"");
	СтруктураНастроек.Вставить("Соглашение_Ключ",				"");
	СтруктураНастроек.Вставить("ГруппаДоступаНоменклатуры_Ключ","");
