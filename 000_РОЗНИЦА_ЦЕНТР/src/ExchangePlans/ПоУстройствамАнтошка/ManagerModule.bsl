...
Функция ПолучитьДанныеУзла(УзелИнформационнойБазы)	Экспорт
	...
	|	ТаблицаУзлов.ТипПрограммы КАК ТипПрограммы,
	|	ЗНАЧЕНИЕ(Перечисление.ВидыУзлов.УстройствоМобильное) КАК ВидУзла,
	...
	Если Выборка.Следующий() Тогда
		...
		ДанныеУзла.ЭлементСтруктуры = Справочники.СтруктураУзлов.ПолучитьСсылку(Выборка.Узел.УникальныйИдентификатор());
