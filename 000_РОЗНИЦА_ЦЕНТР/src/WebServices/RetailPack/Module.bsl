	...
	Если НЕ Результат.Ошибка Тогда
		...
		//	Необходимо записать информацию отправленного сообщения в регистр.
			...
			Исключение
				...
				Результат.ОписаниеОшибки = "Код отправлен, но подтверждение невозможно по причине:" + Символы.ПС + ОписаниеОшибки();
		...
		Если ДанныеОтправителя.Свойство("ДанныеПротокола", ДанныеПротокола) Тогда
			...
			Исключение
				...
				Результат.ОписаниеОшибки = "Ошибка записи в протокол:" + Символы.ПС + ОписаниеОшибки();
...
//	Таблица ответа вызывающему процессу - список обработанных ссылок.
	...
	ТаблицаСсылок.Колонки.Добавить("Объект"   , Новый ОписаниеТипов("ДокументСсылка.ЗаказПокупателя, ДокументСсылка.ЧекККМ, СправочникСсылка.СерийныеНомера"));
