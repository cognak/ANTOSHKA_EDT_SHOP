...
//	ОдинаковИсточникПриемник = (ДокументОбъект.ТипДоставки = Перечисления.ТипДоставкиЗаказПокупателя.Самовывоз);
//	Для Каждого СтрокаТовара Из ДокументОбъект.Товары Цикл
//		Если Не СтрокаТовара.Склад = СтрокаТовара.МагазинПолучатель Тогда
//			ОдинаковИсточникПриемник = Ложь;
//			Прервать;
//		КонецЕсли;
//	КонецЦикла;
