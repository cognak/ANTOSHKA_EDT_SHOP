...
Перем КоличествоСекундВДне Экспорт; //Хранит количество Секунд в дне
...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	МаркетинговыеАкцииСервер.РасчетКоличестваПериодов(НачалоПериода, КонецПериода, ДатаНачалаАкции, КонецПериода, Интервал,
	...
	Если Не Диаграмма Тогда
		ПараметрЗаголовка.Значение = "Оценка продаж. "+ОписаниеПериодаПриведения;
	Иначе
		...
		ПараметрЗаголовка.Значение = "Оценка продаж " + "("+МаркетинговыеАкцииСервер.ПолучитьОписаниеИнтервалаДиаграммы(Интервал) +").";;
