...
Перем КоличествоПериодовДоАкции; // Хранит значение периодов до акции

Перем КоличествоПериодовАкции; // Хранит значение периодов до акции

Перем КоличествоПериодовПослеАкции; // Хранит значение периодов до акции

Перем КоличествоСекундВДне Экспорт; //Хранит количество Секунд в дне

Перем ОписаниеПериодаПриведения; //Хранит Описание периода приведения
...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ПараметрЗаголовка.Значение = "Оценка эффективности маркетинговых мероприятий. "+ОписаниеПериодаПриведения;
