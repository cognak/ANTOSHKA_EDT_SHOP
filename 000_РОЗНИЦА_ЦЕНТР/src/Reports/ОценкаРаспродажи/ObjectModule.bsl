...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если Не Диаграмма Тогда
		ПараметрЗаголовка.Значение = "Оценка распродажи. "+ОписаниеПериодаПриведения;
	...
	Иначе
		...
		ПараметрЗаголовка = КомпоновщикНастроек.Настройки.ПараметрыВывода.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("Title"));
		ПараметрЗаголовка.Значение = "Оценка распродажи " + "("+МаркетинговыеАкцииСервер.ПолучитьОписаниеИнтервалаДиаграммы(Интервал) +").";
