...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Если ФайлБылСоздан Тогда	//	LNK 30.07.2018 12:08:25
...
Процедура ОбновитьИзФайлаНаДиске(Команда)
	...
	Если ЭтоНовый()
	 ...
	 ИЛИ ЭтотОбъект.Объект.ПодписанЭЦП
...
Процедура ПодписатьФайлЭЦП(Команда)
	...
	Если ПрисоединенныеФайлыСлужебныйКлиент.ВыбратьСертификатыЭЦПИСформироватьДанныеПодписи(
			ЭтотОбъект.Объект.Ссылка, ДанныеФайла, ДанныеПодписи) Тогда
...
Процедура Расшифровать(Команда)
	...
	Если ЭтоНовый()
	 ИЛИ НЕ ЭтотОбъект.Объект.Зашифрован Тогда
		Возврат;
	КонецЕсли;
...
Процедура ЗаполнитьСписокПодписей()
	...
	Если ЭтотОбъект.Объект.ПодписанЭЦП Тогда
