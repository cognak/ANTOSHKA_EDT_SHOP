...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для каждого СвойстваПрофиля Из Профили Цикл
		...
		Для каждого ОписаниеВидаДоступа Из ВидыДоступа.НайтиСтроки(Отбор) Цикл
			...
			ОбновитьПредставлениеИспользованияВидаДоступа(ЭтотОбъект, СвойстваПрофиля, ОписаниеВидаДоступа);
			ОбновитьНомерСтрокиПоВиду(ЭтотОбъект, СвойстваПрофиля, ОписаниеВидаДоступа);
		КонецЦикла;
	КонецЦикла;
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Для каждого СвойстваПрофиля Из Профили Цикл
		...
		ПроверитьЗаполнениеПрофиля(ЭтотОбъект, СвойстваПрофиля, Ошибки, Отказ);
