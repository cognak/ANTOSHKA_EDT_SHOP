...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВыбиратьВидПериода = ЗарплатаКадрыКлиентСервер.СвойствоСтруктуры(Параметры, "ВыбиратьВидПериода", Ложь);
	Если ВыбиратьВидПериода Тогда
		ВидыВыбираемыхПериодов = Новый ФиксированныйМассив(ЗарплатаКадрыКлиентСервер.СвойствоСтруктуры(Параметры, "ВидыВыбираемыхПериодов"));
	КонецЕсли;
	
	КлючСохраненияПоложенияОкна = ЗарплатаКадрыКлиентСервер.СвойствоСтруктуры(Параметры, "КлючСохраненияПоложенияОкна", "ОдинПериод");
