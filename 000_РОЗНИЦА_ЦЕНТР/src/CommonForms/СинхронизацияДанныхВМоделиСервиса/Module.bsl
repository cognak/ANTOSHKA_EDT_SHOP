...
Процедура ОтключитьСинхронизациюДанных(Команда)
	...
	Если ТекущиеДанные <> Неопределено
		...
		Иначе
			...
			ОткрытьФорму("Обработка.ПомощникНастройкиСинхронизацииДанныхМеждуПриложениямиВИнтернете.Форма.ОтключениеСинхронизацииДанных", ПараметрыФормы, ЭтотОбъект);
	...
	Если ТекущиеДанные <> Неопределено Тогда
		...
		Иначе
			...
			ОткрытьФорму("Обработка.ПомощникНастройкиСинхронизацииДанныхМеждуПриложениямиВИнтернете.Форма.Форма",
				ПараметрыФормы, ЭтотОбъект, Уникальность, ВариантОткрытияОкна.ОтдельноеОкно
			);
		КонецЕсли;
