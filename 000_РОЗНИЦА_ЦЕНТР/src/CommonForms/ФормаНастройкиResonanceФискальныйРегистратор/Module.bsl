...
//	Пропускаем инициализацию, чтобы гарантировать получение формы при передаче параметра "АвтоТест"
	...
	Буффер = Новый Структура("ЭтоIP, Порт, Скорость, Модель, ТаблицаСоответствийНалоговыхГрупп,ПечатьШК,НовыеФункции");
	...
	Параметры.Свойство("ПечатьШК"	 , Буффер.ПечатьШК);
	Параметры.Свойство("НовыеФункции", Буффер.НовыеФункции);
	...
	ПечатьШК = ?(Буффер.ПечатьШК = Неопределено,    Ложь, Буффер.ПечатьШК);
	НовыеФункции = ?(Буффер.НовыеФункции = Неопределено,    Ложь, Буффер.НовыеФункции);
...
Процедура ЗаписатьИЗакрыть(Команда)
	...
	Параметры.ПараметрыНастройки.Добавить(ПечатьШК  	, "ПечатьШК");
	Параметры.ПараметрыНастройки.Добавить(НовыеФункции	, "НовыеФункции");
...
Процедура УстановитьСпискиВыбора()
	...
	Элементы.Модель.СписокВыбора.Добавить("304Т4" , "Марія 304Т4");
	Элементы.Модель.СписокВыбора.Добавить("304Т5" , "Марія 304Т5");
	Элементы.Модель.СписокВыбора.Добавить("304Т6" , "Марія 304Т6");
...
Функция ПараметрыУстройства()
	...
	ПараметрыУстройства.Вставить("ПечатьШК"	, ПечатьШК);
	ПараметрыУстройства.Вставить("НовыеФункции"	, НовыеФункции);
