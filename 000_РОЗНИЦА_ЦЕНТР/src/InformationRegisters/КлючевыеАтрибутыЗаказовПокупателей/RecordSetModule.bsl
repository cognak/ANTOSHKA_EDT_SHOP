...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	Для Каждого ЗаписьНабора Из ЭтотОбъект Цикл
		...
		СтруктураЗаписи = РегистрыСведений.СостояниеЗаказаПокупателя.ИнициализацияСтрокиЗаписи();
		СтруктураЗаписи.ЗаказПокупателя = ЗаписьНабора.ЗаказПокупателя;
		СтруктураЗаписи.Состояние = ЗаписьНабора.Состояние;
		РегистрыСведений.СостояниеЗаказаПокупателя.ЗаписьВРегистрСтроки(СтруктураЗаписи);
