...
Процедура ЗаписьВРегистрСтроки(СтруктураЗаписи) Экспорт
	...
	Попытка
		...
		ЭлементБлокировки = Блокировка.Добавить("РегистрСведений.СостояниеЗаказаПокупателя");
		ЭлементБлокировки.УстановитьЗначение("ЗаказПокупателя", СтруктураЗаписи.ЗаказПокупателя);
