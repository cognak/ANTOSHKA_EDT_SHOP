...
Функция ИнициализацияСтруктурыЗаписиРегистра(ЗД) Экспорт
	...
	Результат.Вставить("СтатусЗапроса",			Перечисления.СтатусыЗапросовДоступностиТоваровШапка.ПустаяСсылка());
	Результат.Вставить("ОтправкаПочты",			Ложь);
	Результат.Вставить("ОправленоВNavision",	Перечисления.СтатусыЗапросаДоступностиВNavision.ПустаяСсылка());
