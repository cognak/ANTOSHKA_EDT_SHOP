...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПереходНаВерсиюРазрешен = Пользователи.ЭтоПолноправныйПользователь(, Истина);
//	LNK 21.03.2017 13:50:36	- закоментировал
...
Функция СформироватьТаблицуВерсий(Ссылка)
	...
	|	ВерсииОбъектов.ЭлементСтруктуры КАК ЭлементСтруктуры
	|ИЗ
