		...
		Для Каждого СтрокаТабличнаяЧасть Из ВерсияОбъекта.ТабличныеЧасти Цикл
			...
			Если ТабличнаяЧасть.Количество() > 0 Тогда
				...
				Для Каждого СтрокаТабличнойЧасти Из ТабличнаяЧасть Цикл
					...
					УстановитьСвойстваТекста(Секция.Область("R" + Формат(НомерСтроки, "ЧДЦ=; ЧГ=") + "C1"), Формат(НомерСтроки - 1, "ЧДЦ=; ЧГ="), , , , , Истина);
				КонецЦикла;
				...
				Для Каждого КолонкаТабличнойЧасти Из ТабличнаяЧасть.Колонки Цикл
					...
					Для Каждого СтрокаТабличнойЧасти Из ТабличнаяЧасть Цикл
						...
						УстановитьСвойстваТекста(Секция.Область("R" + Формат(НомерСтроки, "ЧДЦ=; ЧГ=") + "C1"), ПредставлениеЗначения, , , , , Истина);
				...
				ТЧОтчета.Область("R" + Формат(ОбластьВывода.Верх, "ЧДЦ=; ЧГ=") + "C1:R" + Формат(ОбластьВывода.Низ, "ЧДЦ=; ЧГ=") + "C" + Формат(НомерКолонки, "ЧДЦ=; ЧГ=")).СоздатьФорматСтрок();
				ТЧОтчета.Область("R" + Формат(ОбластьВывода.Верх, "ЧДЦ=; ЧГ=") + "C2").ШиринаКолонки = 7;
				Для ТекущийНомерКолонки = 3 По НомерКолонки-1 Цикл
					ТЧОтчета.Область("R" + Формат(ОбластьВывода.Верх, "ЧДЦ=; ЧГ=") + "C" + Формат(ТекущийНомерКолонки, "ЧДЦ=; ЧГ=")).ШиринаКолонки = СоответствиеРазмерностиКолонок[ТекущийНомерКолонки];
				КонецЦикла;
				ТЧОтчета.ЗакончитьГруппуСтрок();
		...
		Если ЧтениеXML.ТипУзла = ТипУзлаXML.НачалоЭлемента Тогда
			...
			ИначеЕсли УровеньЧтения = 2 Тогда // указатель на втором уровне - это реквизит или имя табличной части
				...
				Если Не ЗначениеЗаполнено(НовоеЗР.Тип) Тогда
					...
					//	LNK 21.03.2017 10:55:51
					//	Проверим, может быть, это общий реквизит?
						Если ОписаниеРеквизита = Неопределено Тогда

							ОписаниеРеквизита = Метаданные.ОбщиеРеквизиты.Найти(НовоеЗР.НаименованиеРеквизита);
