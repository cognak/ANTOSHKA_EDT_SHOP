...
//  СтоимостьДокумента - Число - Стоимость документа
Процедура ЗаписьСтатуса(ДокументЭН, Статус, СтоимостьДокумента) Экспорт
	
	ЗаписьВРегистр(ДокументЭН, Статус, СтоимостьДокумента);
...
Процедура ЗаписьВРегистр(ДокументЭН, СтатусТТН, СтоимостьДокумента = 0)
	
	Попытка
		СтоимостьДокумента = Число(СтоимостьДокумента);
	Исключение
	...
	Попытка
		...
		НоваяЗапись.СтоимостьДокумента 	= СтоимостьДокумента;
