Процедура ПриЗаписи(Отказ, Замещение)
	...
	//	Если Не ПользовательОбъект.Недействителен = НедействительныйПользователь Тогда
		Если НЕ ПользовательОбъект.ПометкаУдаления = НедействительныйПользователь Тогда	//	LNK 04.03.2024 08:34:14

			НужноЗаписать = Истина;
		//	ПользовательОбъект.Недействителен = НедействительныйПользователь;
		//	LNK 04.03.2024 08:24:39
			ПользовательОбъект.ПометкаУдаления = НедействительныйПользователь;

		КонецЕсли;
		
	//	LNK 04.03.2024 09:27:16 - закоментарил
		//Если НедействительныйПользователь Тогда
	...
	//	Если НедействительныйПользователь Тогда 
		Если ЛОЖЬ Тогда	//	LNK 04.03.2024 09:19:00
