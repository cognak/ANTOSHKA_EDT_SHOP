...
Процедура ЗаписьВРегистр(ДанныеДляЗаписи)
	...
	Для Каждого СтрокаТовара Из ДанныеДляЗаписи.Товары Цикл
		...
		Для Каждого СтрокаЗапросаДоступности Из МассивСтрок Цикл
			...
			Если ДанныеДляЗаписи.ДокументДляЗаписи.СтатусЗапроса = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.Отменён 
					Или ДанныеДляЗаписи.ДокументДляЗаписи.СтатусЗапроса = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.Удалён  
					Или СтрокаЗапросаДоступности.СтатусЗапроса = Перечисления.СтатусыЗапросовДоступностиТоваров.Удалён Тогда 
			...
			ИначеЕсли ДанныеДляЗаписи.ДокументДляЗаписи.МагазинОтправитель = ДанныеДляЗаписи.ДокументДляЗаписи.МагазинПолучатель Тогда
