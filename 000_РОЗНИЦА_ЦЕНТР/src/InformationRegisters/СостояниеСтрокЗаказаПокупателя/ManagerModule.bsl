			...
			Для Каждого СтрокаЗапросаДоступности Из МассивСтрок Цикл
				...
				Иначе
					...
					Если ДанныеЗаказа.ТипОплаты = Перечисления.ТипОплатыЗаказПокупателя.Наличные Тогда
						...
						Если ДанныеДляЗаписи.ДокументДляЗаписи.СтатусЗапроса = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.Отправлен
								Или ДанныеДляЗаписи.ДокументДляЗаписи.ТипДоставки = Перечисления.ТипДоставкиЗаказПокупателя.Самовывоз Тогда
