			...
			Для Каждого СтрокаЗапросаДоступности Из МассивСтрок Цикл
				...
				Иначе
					...
					Если ДанныеЗаказа.ТипОплаты = Перечисления.ТипОплатыЗаказПокупателя.Наличные Тогда
						...
						Если (Не ДанныеДляЗаписи.ДокументДляЗаписи.ТипДоставки = Перечисления.ТипДоставкиЗаказПокупателя.Самовывоз
								И (ДанныеДляЗаписи.ДокументДляЗаписи.СтатусЗапроса = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.Отправлен
									Или ДанныеДляЗаписи.ДокументДляЗаписи.СтатусЗапроса = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.Получен
									Или ДанныеДляЗаписи.ДокументДляЗаписи.СтатусЗапроса = Перечисления.СтатусыЗапросовДоступностиТоваровШапка.ЧекВКЦ))
								Или (ДанныеДляЗаписи.ДокументДляЗаписи.ТипДоставки = Перечисления.ТипДоставкиЗаказПокупателя.Самовывоз
